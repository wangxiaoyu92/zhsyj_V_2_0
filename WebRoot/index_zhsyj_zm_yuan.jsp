...
<%--		<p><a href="<%=contextPath %>/index.jsp" target="_blank">
		...
		<p><a href="http://sa.wanxiangbd.cn:8080/fs-circulation/login" target="_blank">
			<img src="<%=contextPath %>/jsp/tmsyj/tmsyj/images/qyrk.jpg" style="width: 175px;height: 50px;"/></a>
		</p>
		<p><a href="<%=contextPath %>/indexAll_new_zm.jsp" target="_blank">
...
<div class="container" style="width:100%;margin-top:10px;min-width:1130px;">
	<div id="content" style="display: block;">
	    <div class="layout1">
	   		<ul>
	   			<li><a href="javascript:linkToSelf('<%=contextPath %>/jsp/tmsyj/tmcsc/sjaqList.jsp');">
					<img style="height: 155px;" src="<%=contextPath %>/jsp/tmsyj/tmsyj/images/tmxxst.png"></a></li>
	   		...
	   		<ul>
	   			<li><a href="javascript:linkToSelf('<%=contextPath %>/jsp/tmsyj/tmcsc/sjaqList.jsp');"
	   				style="background:#FFFFFF;font-size:20px;font-weight:bold;color:#0076c5;padding:25px;cursor:pointer;">学校食堂</a></li>
	   			<li><a href="javascript:linkToSelf('<%=contextPath %>/jsp/tmsyj/tmcsc/enterprise_list.jsp?comdalei=101401&currlocation=放心菜市场');"
