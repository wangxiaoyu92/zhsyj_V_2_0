...
<script type="text/javascript">
	...
	function reqTOBankend(pageIndex, pageSize, commc) {
		...
		$.post(basePath + '/jk/jkgl/queryJky',{
			page : displayIndex,
			rows : displaySize,
			jkqymc : commc,
			jkqybh : '2016062816104755797131318'//演示写死
		},
		function(result) {
			if (result.code == '0') {
				...
				for ( var i = 0; i < data.length; i++) {
					...
					var jkybh = rowData.jkybh;
					var jkymc = rowData.jkymc;					
					var	imgUrl = "/images/jd.png";//演示写死

					str += '<li  onclick=showSpjky("' + jkybh
							+ '") >';
	...
	// 佳多物联网视频监控
	var showSpjky = function(jkybh) {
		var url = "http://wulianwang.jiaduo.com:8100/jdwlw/min/spaq/video/" + jkybh;
...
<body>
	<div class="search-shop-box group-shop-mode" style="padding-top: 20px">
