...
<%--	<div data-options="region:'north',href:'<%=contextPath%>/jsp/wl/zy/sjjk/north.jsp'" style="height: 70px; overflow: hidden; background:url(<%=contextPath%>/images/frame/head_bg.jpg) repeat-x; " ></div>--%>
	<div data-options="region:'west',href:'<%=contextPath%>/jsp/jk/west.jsp?comdalei=<%=comdalei%>',split:true" title="导航" style="width: 300px; ">		
	</div>
