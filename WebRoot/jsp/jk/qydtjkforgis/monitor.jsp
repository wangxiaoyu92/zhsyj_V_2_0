...
<%
	...
	String gisAddress = ((Aa01) SysmanageUtil.getAa01("GIS_ADDRESS")).getAaa005();
...
<head>
	...
	<script src="http://webapi.amap.com/maps?v=1.3&key=242ac779e3b541ba8bcf5990601e3768"></script>
	...
	<%--超图js加载--%>
	<script type="text/javascript" src="<%=contextPath %>/jslib/supermap/libs/SuperMap.Include.js"></script>
	<script type="text/javascript" src="<%=contextPath %>/jslib/supermap/iConnector/iConnectorAMap.js"></script>
	<script type="text/javascript">
		var mapObj, firstloaded=true,canvasTiles,
				host = gisAddress,
				url=host+"/iserver/services/map-zmd/rest/maps/xq"  ;
		function addThemeDotDensity()
		{
			if(firstloaded){
				canvasTiles =  SuperMap.Web.iConnector.AMap.getLayer(url);
