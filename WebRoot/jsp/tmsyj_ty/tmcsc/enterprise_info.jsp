...
%>
<%
	String t_currlocation = "菜市场>>食品安全信息公示";
	...
	<div class="row" style="margin-top:10px;">
			...
			<div class="container">			
		   	...
		   	<div id="transparent" style="padding-bottom:10px;">
				<div class="enterprise-transparent">
					...
					<a href="javascript:linkToSelf('enterprise_material_list.jsp?currlocation=<%=t_commc %>>>食品信息透明&comid=<%=t_comid %>');"
						style="background: #ff6950;" id="cgtm">食品信息透明</a>
					<a href="javascript:linkToSelf('enterprise_fastcheck_list.jsp?currlocation=<%=t_commc %>>>检测结果透明&comid=<%=t_comid %>');"
						style="background: #b845ac;" id="jctm">检测结果透明</a><a href="javascript:linkToSelf('enterprise_kitchen_list.jsp?currlocation=<%=t_commc %>>>社会监督透明&comid=<%=t_comid %>');"
						style="background: #4fb901;" id="cftm">社会监督透明</a>
				</div>
				<div class="enterprise-transparent">
					...
					<a href="javascript:linkToSelf('enterprise_review_list.jsp?currlocation=<%=t_commc %>>>公众评价透明&comid=<%=t_comid %>');"
						style="background: #f3395f;" id="gztm">公众评价透明</a>
				</div>
			</div>					    
			<div class="enterpriseProfile" style="margin-top:10px;">
				<div class="header">
					<span style="">市场分区</span>
				</div>
				<div class="content" id="guihuatu" style="margin-top:10px;"></div>
			</div>		   		
			<div class="enterpriseProfile" style="margin-top:10px;">
				<div class="header">
		...
		<div class="col-xs-4 col-sm-4" id="news2">			
			...
			<div style="width:200px;height:200px;" id="qrcode_div">
		   	...
		   	<!--地图容器-->
		    <div id="mapContainer" style="width:400px;height:200px;border:#00A1EA solid 1px;margin-top:3px;">
		         &nbsp;
		    </div>				
		</div>	
	</div>
...
<script type="text/javascript">
	...
	$(function () {
		...
		//初始化市场分区
        if(t_comxiaolei.indexOf("10140103")){
        	$("#guihuatu").load("csfq.html");
        }else{
        	$("#guihuatu").load("scfq.html");
        }
        initMap();
        getPcompany();
        getFjList(1,10);
