            	...
            	if(result.code == '0'){
            		rcjc_options.currentPage = result.currPage;
                 	...
                 	$.each(result.rows, function (index, item) {
						...
						html += " <tr>";
                     	html += "   <td><a href=\"javascript:linkToSelf('" + basePath +"api/tmsyj/getJdjcResultDetail?comid=" + IsNull(item.comid) + "&commc="+ IsNull(item.commc) + "&resultid="+ IsNull(item.resultid) + "');\" style=\"font-size:14px;color:#0000F0;text-decoration:none;font-weight:bold;\">检查计划："  + IsNull(item.plantitle) + "</a></td>";
                     	html += " </tr>";
                     	html += " <tr>";
                     	...
                     	html += " </tr>";
						html += " <tr>";
                     	html += "   <td><a href=\"javascript:linkToSelf('enterprise_punish_info.jsp?comid=" + IsNull(item.comid) + "&commc="+ IsNull(item.commc) + "&resultid="+ IsNull(item.resultid) + "&plantitle="+ IsNull(item.plantitle) + "&operateperson="+ IsNull(item.operateperson) + "&resultdate="+ IsNull(item.resultdate) + "');\" style=\"font-size:14px;color:#0000F0;text-decoration:none;font-weight:bold;\">查看附件</a></td>";
                     	html += " </tr>";	
                        html += "</table>";
	                    html += "</li>";
