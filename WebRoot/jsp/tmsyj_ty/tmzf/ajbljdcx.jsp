    ...
    <div class="row" style="margin-top:10px;">
        <div class="col-xs-12 col-sm-12" style="text-align:center;">
            ...
            <div class="tab_title" style="border-bottom:1px solid #048ad3;width:100%;height:40px; line-height:40px; margin-top:10px;">
                <div id="table_0" class="table_show" style="width:30%;" onclick="sele_show(0)">案件办理进度</div>
            </div>            
            <div class="tab_list">            
  	 			<iframe src='<%=contextPath%>/jsp/gzfw/ajbljdcx.jsp' frameborder="0" scrolling="no"  width="970" height="800"></iframe>
	        </div>   
		</div>      
	</div>
</div>
