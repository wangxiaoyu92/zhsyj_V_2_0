...
<body class="easyui-layout">
	<div region="center" style="overflow: true;" border="false">
		...
		<input type="hidden" id="jgztpickind" name="jgztpickind" value="2"/>
		...
		<input type="hidden" id="aae036" name="aae036"/>
	       		...
	       		<table class="table" style="width: 99%;"> 				
					<tr>
						<td style="text-align:right;"><nobr>检测人员:</nobr></td>
						<td><input name="zcry" id="zcry"  style="width: 200px;" class="easyui-validatebox" data-options="required:true"/>
						</td>
					</tr>
					<tr>
						<td style="text-align:right;"><nobr>检测机构:</nobr></td>
						<td><input name="jcdw" id="jcdw"  style="width: 200px;" class="easyui-validatebox" data-options="required:true"/>
						</td>
					</tr>					
					<tr>									
						<td style="text-align:right;"><nobr>检测时间:</nobr></td>
