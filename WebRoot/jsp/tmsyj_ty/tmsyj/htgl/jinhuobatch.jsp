...
<%-- <script type="text/javascript" src="<%=basePath%>jslib/jquery-1.9.1.js"></script> --%>

<script type="text/javascript" src="<%=basePath%>jslib/jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="<%=basePath%>jslib/jquery.json-2.4.min.js"></script>

<script type="text/javascript" src="<%=basePath%>jslib/Globals.js"></script>
<script type="text/javascript" src="<%=basePath%>jslib/common.js"></script>
<script type="text/javascript" src="<%=basePath%>jslib/quanju.js"></script>
<script type="text/javascript" src="<%=basePath%>jslib/storage.js"></script>

<%-- <script type="text/javascript" src="<%=basePath%>jslib/jquery-easyui-1.5.3/jquery.min.js"></script> --%>  
<script type="text/javascript" src="<%=basePath%>jslib/jquery-easyui-1.5.3/jquery.easyui.min.js"></script>  
<link rel="stylesheet" href="<%=basePath%>jslib/jquery-easyui-1.5.3/themes/default/easyui.css" type="text/css"></link>  
<link rel="stylesheet" href="<%=basePath%>jslib/jquery-easyui-1.5.3/themes/icon.css" type="text/css"></link>  
<script type="text/javascript" src="<%=basePath%>jslib/jquery-easyui-1.5.3/locale/easyui-lang-zh_CN.js"></script> 
...
<%-- <jsp:include page="${contextPath}/incb.jsp"></jsp:include> --%>
...
<script type="text/javascript">
	...
	var v_jhqrbz2=<%=SysmanageUtil.getAa10toJsonArray("JHQRBZ")%>;
			...
			columns : [[
	        {
				...
				formatter:function(value,row){
					if (row.jhqrbz=null || row.jhqrbz=="" || row.jhqrbz=="0"){
						return '<span style="color:red">'+sy.formatGridCode(v_jhqrbz2,value);+'</span>';
					}else{
						return '<span style="color:blue">'+sy.formatGridCode(v_jhqrbz2,value);+'</span>';
					}
				}					
			},{
				width : '75',
	...
	function mybatchAddSave(){
		var url= basePath+'/tmsyjhtgl/saveBatchjinhuo';
         ...
         if (v_batchjinhuoinsertrows && v_batchjinhuoinsertrows.length>0){
        	 $('#batchjinhuoinsertrows').val(JSON.stringify(v_batchjinhuoinsertrows));
         }else{
        	 $('#batchjinhuoinsertrows').val('');
         }
         if (v_batchjinhuoupdaterows && v_batchjinhuoupdaterows.length>0){
        	 $('#batchjinhuoupdaterows').val(JSON.stringify(v_batchjinhuoupdaterows));  
         }else{
        	 $('#batchjinhuoupdaterows').val('');  
         }
	        ...
	        success: function(result){
	        	...
	        	result = $.parseJSON(result);  
			 	if (result.code=='0'){
                    ...
                    mygridbatchdetail.datagrid("loadData",{ "total":"0",rows:[] });
