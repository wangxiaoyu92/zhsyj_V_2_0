...
<script type="text/javascript">
    ...
    function getCpxxtmList(page,pageSize) {
    	$.ajax({
        	url: basePath + "api/tmsyj/getZcbList",//检验检测图片
        	type: "post",
            dataType: 'json',
            data: { page: page, rows: pageSize, hviewjgztid: t_comid,jgztpickind:'2' },
                	...
                	$('#content').empty();
                 	$.each(result.rows, function (index, item) {
	                    ...
	                    var h_txt = "";
                     	...
                     	html += "         <a href=\"javascript:linkToSelf('jyjctm_info.jsp?hviewjgztid=" + IsNull(item.hviewjgztid) + "&fjwid="+ IsNull(item.hjgztxgpicid) +  "');\"><img src=\"" + checkImg(item.fjpath) + "\" style=\"height:120px;width:160px;\" /></a>";
                     	html += "     </td>";
                     	html += "     <td><a href=\"javascript:linkToSelf('jyjctm_info.jsp?hviewjgztid=" + IsNull(item.hviewjgztid) + "&fjwid="+ IsNull(item.hjgztxgpicid)  +  "');\" style=\"font-size:17px;color:#0000F0;text-decoration:none;font-weight:bold;\" >检验检测报告生成时间:" + IsNull(item.zcsj) + "</a></td>";
                     	html += " </tr>";
                     	html += " <tr>";
