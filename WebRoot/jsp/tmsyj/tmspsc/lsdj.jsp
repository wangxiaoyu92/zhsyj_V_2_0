    ...
    <div class="row" style="margin-top:10px;">
        <div class="col-xs-12 col-sm-12" style="text-align:center;">
            ...
            <div class="tab_title" style="border-bottom:1px solid #048ad3;width:100%;height:40px; line-height:40px; margin-top:10px;">
                <div id="table_0" class="table_show" style="width:100%;" onclick="sele_show(0)">历史等级</div>
            </div>
            <div class="tab_list"> 
...
<script type="text/javascript">
    ...
    $(function () {                
        ...
        getLsdjtmList(1, v_pageSize);                 
    });

   function getLsdjtmList(page,pageSize,t_aaa027) {
    	$.ajax({
        	url: basePath + "api/tmsyj/getLsdjtmList",
        	type: "post",
            dataType: 'json',
                	...
                	$('#content').empty();
                 	$.each(result.rows, function (index, item) {
						...
						html += "   <td style=\"font-size:16px;color:#0000F0;text-decoration:none;font-weight:bold;\">评定等级："  + IsNull(item.lhfjndpddj) + "</td>";
                     	html += "   <td style=\"font-size:16px;color:#0000F0;text-decoration:none;font-weight:bold;\">检查次数："  + IsNull(jccs) + "</td>";
