            	...
            	if(result.code == '0'){
            		options.currentPage = result.currPage;
                 	...
                 	$.each(result.rows, function (index, item) {
                        ...
                        html += "<td><a href=\"enterprise_person_info.jsp?ryid=" + item.ryid + "&ryxm="+ item.ryxm + "&ryzwgw=" + item.ryzwgwinfo + "&rylxdh=" + item.rylxdh + "&ryzt=" + item.ryztinfo + "\" target='self' style=\"background: #4fb9f1;color: #fff;padding: 5px 5px;border-radius: 6px;font-size:11pt;text-decoration:none;\">查看证件</a></td>";
                        html += "</tr>";
