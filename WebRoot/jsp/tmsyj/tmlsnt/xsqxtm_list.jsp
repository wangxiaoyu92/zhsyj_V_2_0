    ...
    <div class="row" style="margin-top:10px;">
        <div class="col-xs-12 col-sm-12" style="text-align:center;">
            <div class="tab_title" style="border-bottom:1px solid #048ad3;width:100%;height:40px;
                ...
                <div id="table_0" class="table_show" style="width:50%;" onclick="sele_show(0)">产品销售信息</div>
            </div>
            <div class="tab_list">
...
<script type="text/javascript">
    ...
    function getXsqxtmList(page, pageSize) {
    	$.ajax({
        	url: basePath + "api/tmsyj/getSycpxsqxtmList",
        	type: "post",
            dataType: 'json',
            	...
            	if(result.code == '0'){
                	...
                	$('#content tbody').empty();
                 	$.each(result.rows, function (index, item) {
                        ...
                        html += "<td>" + IsNull(item.tocom) + "</td>";
                        html += "<td>" + IsNull(item.lgsproname) + "</td>";
                        html += "<td>" + IsNull(item.lgsprojysl) + "</td>";
                        html += "<td>" + IsNull(item.lgsprojydwmc) + "</td>";
                        html += "<td>" + IsNull(item.lgsprojyrq) + "</td>";
                        html += "<td>" + IsNull(item.lgspropc) + "</td>";
                        if (IsNull(item.lgsjylx) == "2") {
                            html += "<td>范围外交易</td>";
                        } else {
                            html += "<td>范围内交易</td>";
                        }
                        html += "<td><a href=\"javascript:void(0);\" onclick=\"productfjcx('" + item.lqledgersalesid + "');\" style=\"background: #4fb9f1;color: #fff;padding: 5px 5px;border-radius: 6px;font-size:11pt;text-decoration:none;\">交易附件</a></td>";
                        html += "</tr>";
