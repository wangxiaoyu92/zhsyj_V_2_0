...
%>
<%
	String t_currlocation = "绿色农田>>食品安全信息公示";
...
<head>
	...
	<%
		String zxdjdzb = (SysmanageUtil.getAa01("ZXDJDZB")).getAaa005();
		String zxdwdzb = (SysmanageUtil.getAa01("ZXDWDZB")).getAaa005();
	%>
		...
		<div class="col-xs-8 col-sm-8" style="text-align:left;">
			<div class="leftcontent">
				...
				<div style="height:200px;margin-bottom:10px;margin-top:10px;">
					<div id="DynamicLevel" style="width:50%;float:left;background:url(images/jdgldj1.jpg);background-size:100% 100%;height:200px;">
						<img id="lhfjndpddj"  src="images/1-A.png" style="width:202px;height:100px;margin-top:15%;margin-left:60px;">
					</div>
					<div style="width:50%;float:left;background:url(images/jdgldj2.jpg);background-size:100% 100%;height:200px;"></div>
				</div>
				<div id="transparent" style="padding-bottom:10px;">
					<div class="enterprise-transparent">
						<a href="javascript:linkToSelf('enterprise_person_list.jsp?currlocation=<%=t_commc%>>>企业资质透明&comid=<%=t_comid%>');" style="background: #df83ff;" id="rytm">企业资质透明</a>
						<a href="javascript:linkToSelf('enterprise_kitchen_list.jsp?currlocation=<%=t_commc%>>>种植过程透明&comid=<%=t_comid%>');" style="background: #4fb901;" id="cftm">种植过程透明</a>
						<a href="javascript:linkToSelf('qyzctm_list.jsp?currlocation=<%=t_commc%>>>企业自查透明&comid=<%=t_comid%>');" style="background: #ff6950;" id="zctm">企业自查透明</a>
						<a href="javascript:linkToSelf('cpxxtm_list.jsp?currlocation=<%=t_commc%>>>产品信息透明&comid=<%=t_comid%>');" style="background: #b845ac;" id="jctm">产品信息透明</a>
					</div>
					<div class="enterprise-transparent">
						<a href="javascript:linkToSelf('xsqxtm_list.jsp?currlocation=<%=t_commc%>>>销售去向透明&comid=<%=t_comid%>');" style="background: #4fb9f1;" id="xstm">销售去向透明</a>
						<a href="javascript:linkToSelf('jyjctm_list.jsp?currlocation=<%=t_commc%>>>监督抽检透明&comid=<%=t_comid%>');" style="background: #d21323;" id="jdtm">监督抽检透明</a>
						<a href="javascript:linkToSelf('enterprise_punish_list.jsp?currlocation=<%=t_commc%>>>执法监管透明&comid=<%=t_comid%>');" style="background: #ff65ac;" id="zftm">执法监管透明</a>
						<a href="javascript:linkToSelf('enterprise_material_list.jsp?currlocation=<%=t_commc%>>>原料采购透明&comid=<%=t_comid%>');" style="background: #f3395f;" id="cgtm">原料采购透明</a>
					</div>
				</div>
...
<script type="text/javascript">
	...
	function wyts(){
		window.open("http://12331.hda.gov.cn/");
	}
</script>
<script type="text/javascript">
	/*********跑马灯效果***************/
