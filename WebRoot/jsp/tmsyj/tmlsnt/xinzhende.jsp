...
%>
<%
	String t_currlocation = "绿色农产品>>鑫贞德农业";
		...
		<div class="col-xs-8 col-sm-8" style="text-align:left;">
			<div class="leftcontent">
				...
				<div class="enterpriseProfile" style="margin-top:10px;">
					...
					<div style="width:650px;height:400px;overflow:hidden;border:1px solid Olive;margin-top:10px;" id="csctu">
						<img src="images/scfq.jpg" border="0" style="width:100%;height:100%;">
					</div>
				</div>
				<div class="enterpriseProfile" style="margin-top:10px;">
					<div class="header">
            ...
            success: function(result){
                if(result.code == '0'){
                    if(result.total>0){
                        ...
                        wdzb = item.comwdzb;
                        address = item.comdz;
                        addMarker_tantiao_no(jdzb,wdzb,address,"",t_commc,"images/marker_red.png");
                    }
                }else{
                    alert(result.msg);
                }
