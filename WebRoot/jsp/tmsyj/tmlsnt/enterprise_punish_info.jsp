    ...
    <div class="row" style="margin-top:10px;">
        <div class="col-xs-12 col-sm-12" style="text-align:center;">
			...
			<div class="tab_title" style="border-bottom:1px solid #048ad3;width:100%;height:40px; line-height:40px; margin-top:10px;">
				<div id="table_0" class="table_show" style="width:50%;" >监管检查附件</div>
			</div>
			<div class="tab_list">
				<%--<div id="tables_0" class="tables" style="display:none;width:100%">--%>
					<%--<ul id="content"></ul>--%>
					<%--<ul id="page_list"></ul>--%>
				<%--</div>--%>
            	...
            	if(result.code == '0'){
            		...
            		$('#content').empty();           		
                 	$.each(result.rows, function (index, item) {
                        ...
                        html += " <tr>";
                        html += "   <td style=\"text-align:center\"><img style=\"width:100%;height:50%;\" src=\"" + checkImg(item.fjpath) + "\"></td>";
