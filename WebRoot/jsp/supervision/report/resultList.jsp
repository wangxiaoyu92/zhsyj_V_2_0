...
<%
	...
	String daleiname = StringHelper.showNull2Empty(request.getParameter("daleiname"));
	String resultstate = StringHelper.showNull2Empty(request.getParameter("resultstate"));
	String year = StringHelper.showNull2Empty(request.getParameter("year"));
%>
<!DOCTYPE html>
<html>
	...
	<script type="text/javascript">
		...
		function reload() {
			...
			table.reload('roleTable', {
				url: basePath + 'supervision/checkresult/resultReportlist',
				where: {
					'resultstate': resultstate,
					'year': year,
					'aaa027': aaa027name,
						...
						<div class="layui-row">
							...
							<div class="layui-col-md4 layui-col-xs12 layui-col-sm6">
								<div class="layui-form-item">
									...
									<div class="layui-input-inline">
										<input type="text" id="commc" name="commc" autocomplete="off" class="layui-input">
									</div>
								</div>
							</div>
							<div class="layui-col-md4 layui-col-xs12 layui-col-sm6">
							...
							<div class="layui-col-md6 layui-col-xs12 layui-col-sm12">
								<div class="layui-form-item">
									...
									<div class="layui-inline">
										<input id="operatedate" name="operatedate" class="layui-input test-item" placeholder="yyyy-MM-dd" type="text">
									</div>
									&nbsp;-&nbsp;
									<div class="layui-inline">
										<input id="operateenddate" name="operateenddate" class="layui-input test-item" placeholder="yyyy-MM-dd" type="text">
									</div>
