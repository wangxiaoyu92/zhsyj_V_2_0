...
<div class="mid_bg">
  <div class="top_4">
    <div class="top_4d fl" id="DangQianWeiZhi"><span>当前位置</span>&nbsp;&gt;&nbsp;法律法规&nbsp;&gt;&nbsp;法律</div>    
    <div class="top_4c fr">
...
<div class="mid_bg">
  ...
  <div class="ntit_2">
    <ul>
      <li class="marr10"><a id="flfg_fl"  href="<%=contextPath %>/news/queryNewsList?retPageStr=fl&pageSize=20&cateJc=flfg_fl&page=1" class="curr">法律</a></li>
