...
<div class="mid_bg">
   <div class="top_4">
	  <div class="top_4d fl" id="DangQianWeiZhi"><span>当前位置</span>&nbsp;&gt;&nbsp;红黑榜&nbsp;&gt;&nbsp;食品</div> 
	  <div class="top_4c fr">
...
<script type="text/javascript">
  function myshowpostion(){
	  ...
	  if (v_local_cateJc==null || v_local_cateJc=="" || v_local_cateJc=="ggtz_sp"){
		  DangQianWeiZhi.innerHTML="<span>当前位置</span>&nbsp;&gt;&nbsp;红黑榜&nbsp;&gt;&nbsp;食品";
	  }else if (v_local_cateJc=="ggtz_yp"){
		  DangQianWeiZhi.innerHTML="<span>当前位置</span>&nbsp;&gt;&nbsp;红黑榜&nbsp;&gt;&nbsp;药品";
	  }else if (v_local_cateJc=="ggtz_bjp"){
		  DangQianWeiZhi.innerHTML="<span>当前位置</span>&nbsp;&gt;&nbsp;红黑榜&nbsp;&gt;&nbsp;保健品";
	  }else if (v_local_cateJc=="ggtz_hzp"){
		  DangQianWeiZhi.innerHTML="<span>当前位置</span>&nbsp;&gt;&nbsp;红黑榜&nbsp;&gt;&nbsp;化妆品";
	  }else if (v_local_cateJc=="ggtz_ylqx"){
		  DangQianWeiZhi.innerHTML="<span>当前位置</span>&nbsp;&gt;&nbsp;红黑榜&nbsp;&gt;&nbsp;医疗器械";
	  }
  }
  myshowpostion();
</script>
...
<div class="mid_bg">
  ...
  <div class="ntit_2">
    <ul>
      <li class="marr10"><a id="ggtz_sp"  href="<%=contextPath %>/news/queryBordList?retPageStr=<%=v_retPageStr %>&pageSize=<%=v_pageSize%>&cateJc=ggtz_sp&page=1" class="curr" >食品</a></li>
      <li class="marr10"><a id="ggtz_yp"  href="<%=contextPath %>/news/queryBordList?retPageStr=<%=v_retPageStr %>&pageSize=<%=v_pageSize%>&cateJc=ggtz_yp&page=1">药品</a></li>
      <li class="marr10"><a id="ggtz_bjp" href="<%=contextPath %>/news/queryBordList?retPageStr=<%=v_retPageStr %>&pageSize=<%=v_pageSize%>&cateJc=ggtz_bjp&page=1" >保健品</a></li>
      <li class="marr10"><a id="ggtz_hzp" href="<%=contextPath %>/news/queryBordList?retPageStr=<%=v_retPageStr %>&pageSize=<%=v_pageSize%>&cateJc=ggtz_hzp&page=1">化妆品</a></li>
      <li class="marr10"><a id="ggtz_ylqx" href="<%=contextPath %>/news/queryBordList?retPageStr=<%=v_retPageStr %>&pageSize=<%=v_pageSize%>&cateJc=ggtz_ylqx&page=1">医疗器械</a></li>
    </ul>
  </div>
  
  <%@ include file="bordmiddle.jsp"%>
