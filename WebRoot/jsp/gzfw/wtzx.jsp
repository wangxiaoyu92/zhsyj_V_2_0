...
$(function(){
	...
	$('#qhdCxmm').blur(function(){
    	var qhdCxmm=$('#qhdCxmm').val();
    	var hdCxmm=$('#hdCxmm').val();
    	if(qhdCxmm!=hdCxmm){
    		$('#mm').show();
    	}else
    		$('#mm').hide();
...
<div class="mid_bg">
  <div class="top_4">
    <div class="top_4d fl" id="DangQianWeiZhi"><span>当前位置</span>&nbsp;&gt;&nbsp;政民互动&nbsp;&gt;&nbsp;问题咨询</div>    
    <div class="top_4c fr">
	      ...
	      <form id="myform" >
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
			     <td>咨询类型：</td>
			     <td>
			      <input name="hdLx" id="hdLx"  style="height: 25px;width: 333px;font-size: 15px"/> 
			      <span class="txt_red">*</span>
			     </td>
			  </tr>
			  <tr>
			    <td>&nbsp;</td>
			    <td height="30" valign="top"><span class="txt_grey">如果您咨询的问题并未涉及隐私敏感，选择公开则可以让和您有类似问题的人看到。</span></td>
			  </tr>
			  <tr>
			    <td>咨询内容：</td>
			  ...
			  <tr>
			    <td>&nbsp;</td>
			    <td height="30" valign="top"><span class="txt_grey">主要咨询的问题内容、想得到怎样的帮助等，尽量详细。</span></td>
			  </tr>
