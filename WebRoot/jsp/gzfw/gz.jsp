...
<div class="mid_bg">
  <div class="top_4">
    <div class="top_4d fl" id="DangQianWeiZhi"><span>当前位置</span>&nbsp;&gt;&nbsp;法律法规&nbsp;&gt;&nbsp;规章</div>    
    <div class="top_4c fr">
...
<script type="text/javascript">
  function myshowpostion(){
	  ...
	  if (v_local_catejc==null || v_local_catejc=="" || v_local_catejc=="flfg_gz"){
...
<div class="mid_bg">
  ...
  <div class="ntit_2">
     <ul>
      ...
      <li class="marr10"><a id="flfg_gz"  href="<%=contextPath %>/news/queryNewsList?retPageStr=gz&pageSize=20&cateJc=flfg_gz&page=1" class="curr">规章</a></li>
