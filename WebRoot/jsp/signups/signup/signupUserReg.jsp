	...
	<div class="easyui-layout" fit="true" >
        ...
        <form name="myform" id="myform" method="post" >
			<div style="text-align: center;">
				<img src="<%=basePath%>images/zc/zctop.png" width="100%" height="100px;"/>
			</div>
			...
			<table  align="center" style="border-spacing:8px;" class="mytable">
				<tr>
				    <td style="text-align:right;">
						<nobr><font class="myred">*</font>登录账号(建议字母或数字):</nobr>
					</td>
				    <td colspan="3">
						<input id="username" name="username" style="width: 200px"
				...
				<tr>
				    <td style="text-align:right;">
						<nobr><font class="myred">*</font>真实姓名:</nobr>
					</td>
				    <td colspan="3">
				...
				<tr>
				    ...
				    <td colspan="3" >
				    	<input type="password" id="passwd" name="passwd"  autocomplete="off"
							   style="width: 200px;float:left;vertical-align:middle;"
				    			class="easyui-validatebox input-text"
				...
				<tr>
					...
					<td colspan="3">
						<input name="aaa027name" id="aaa027name"  style="width: 200px; "
							   ...
							   class="easyui-validatebox input-text" data-options="required:true" />
						...
						<div id="menuContent_aaa027" class="menuContent"
							...
							<ul id="treeDemo_aaa027" class="ztree"
								style="margin-top:0px;width:250px;height:250px;"></ul>
						</div>							
					</td>
				</tr>	
				<tr>
				...
				<tr>
					<td style="text-align:right;">
						<nobr><font class="myred">*</font>电子邮箱email(找回密码用到):</nobr>
					</td>
					<td colspan="3"><input id="useremail" name="useremail" style="width: 500px" 
						class="easyui-validatebox input-text"
						data-options="required:true,validType:['length[0,100]','email']"/>
					</td>
				</tr>						
				<tr>
					<td style="text-align:right;">
						<nobr><font class="myred">*</font>单位名称:</nobr></td>
			    ...
			    <tr>
					<td colspan="4" align=center>
					   <input type="button" value="确认注册"
							  class="btn_bg" onMouseOver="this.className='btn_bg_hover'"
						...
						<input type="button" value="返回"  class="btn_bg"
							   onMouseOver="this.className='btn_bg_hover'" onMouseOut="this.className='btn_bg'"
