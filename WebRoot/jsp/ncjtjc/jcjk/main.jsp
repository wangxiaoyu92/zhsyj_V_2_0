...
<%--	<div data-options="region:'north',href:'<%=contextPath%>/jsp/ncjtjc/jcjk/north.jsp'" style="height: 70px; overflow: hidden; background:url(<%=contextPath%>/images/frame/head_bg.jpg) repeat-x; " ></div>--%>
	<div data-options="region:'west',href:'<%=contextPath%>/jsp/ncjtjc/jcjk/west.jsp',split:true" title="导航" style="width: 300px; ">		
	</div>
	<div data-options="region:'center'" style="overflow: hidden;">
		<div id="mainTabs" >
			<div title="欢迎使用" data-options="iconCls:'ext-icon-heart'">
				<iframe src="<%=contextPath%>/jk/jkgl/jcjkmonitorIndex" allowTransparency="true" style="border: 0; width: 100%; height: 99%;" frameBorder="0"></iframe>
			</div>
		</div>
	</div>
