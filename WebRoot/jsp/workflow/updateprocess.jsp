...
<script charset="UTF-8" src="<%=basePath%>/jsp/workflow/updateprocess.js" language="javascript"></script>
<script>
//关闭并刷新父窗口
...
<body onload="init()" onunload="closeAndRefreshWindow()" onselectstart="return false;" style="margin: 0px;">
