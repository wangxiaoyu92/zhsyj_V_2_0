...
$(function() {
		...
		mygrid = $('#mygrid').datagrid({
			...
			//iconCls: 'icon-tip',
			toolbar: '#toolbar',
			url: basePath + '/zfba/ajla/queryAjla',
			...
			{field:'opt',title:'操作',align:'left',width:200,
              formatter:function(value,rec){   
		    	  var v_OperRet='<a href="javascript:uploadFuJian('+rec.ajdjid
		    	  		+')" mce_href="#"><img src="../../images/pub/upload.png" align="absmiddle">附件管理</a>&nbsp;';
		    	      v_OperRet+='<a href="javascript:wenshuguanli('+rec.ajdjid
		    	      	+')" mce_href="#"><img src="../../images/pub/export_file.png" align="absmiddle">文书管理</a>&nbsp;';
...
function myselectcom(){
	...
	function addAjla(){
		var dialog = parent.sy.modalDialog({
			...
			width : 870,
			height : 500,
			url : basePath + '/zfba/ajla/ajlaFormIndex',
			buttons : [ {
				text : '确定',
				handler : function() {
					...
					<table>
						<tr>
							<td><a href="javascript:void(0)" class="easyui-linkbutton"
								data="btn_addAjla" iconCls="icon-add" plain="true"
								onclick="addAjla()">立案</a>
							</td>
							<td>
							...
							<td><a href="javascript:void(0)" class="easyui-linkbutton"
								data="btn_delAjdj" iconCls="icon-remove" plain="true"
