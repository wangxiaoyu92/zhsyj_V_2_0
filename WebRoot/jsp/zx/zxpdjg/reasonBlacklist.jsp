...
//            intSelectData('djcshh', djcshh);
            layui.use(['form', 'table', 'layer', 'element'], function () {
                ...
                table.render({
                    ...
                    , cols: [[
                        ...
                        , {field: 'reason', width: 150, title: '救济原因', event: 'trclick'}
                    ]]
                });
        ...
        function add() {
            sy.modalDialog({
                area: ['100%', '100%']
                , title: '新增'
                , content: basePath + '/zx/zxpdjg/reasonBlacklistForm?djcshh='+v_djcshh+ '&op=add'
                , btn: ['保存', '取消'] //可以无限个按钮
        ...
        function edit(pdjgid) {
            sy.modalDialog({
                area: ['100%', '100%']
                , title: '编辑'
                , content: basePath + '/zx/zxpdjg/reasonBlacklistForm?pdjgid=' + pdjgid + '&op=edit'+ '&djcshh='+v_djcshh
                , btn: ['保存', '取消'] //可以无限个按钮
                , btn1: function (index, layero) {
                    window[layero.find('iframe')[0]['name']].submitForm();
                }
        ...
        function show(pdjgid) {
            sy.modalDialog({
                area: ['100%', '100%']
                , title: '查看'
                , content: basePath + '/zx/zxpdjg/reasonBlacklistForm?pdjgid=' + pdjgid + '&op=view'+ '&djcshh='+v_djcshh
                , btn: ['关闭'] //可以无限个按钮
            })
        }
        //子页面返回参数
