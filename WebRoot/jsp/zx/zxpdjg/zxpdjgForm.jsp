...
<div class="layui-table">
    <div region="center" style="overflow: visible;" border="false">
        <form class="layui-form" action="" id="zxpdjgForm" style="padding-left: 138px">
            ...
            <div class="layui-form-item">
                ...
                <%} %>
                <label class="layui-form-label" id="bcytel" style="width: 185px"><font
            ...
            <div class="layui-form-item">
                ...
                <label class="layui-form-label" style="width: 295px"><font class="myred">*</font>得分：</label>
                <div class="layui-input-inline">
            ...
            <div class="layui-form-item">
                ...
                <label class="layui-form-label" style="width: 295px">等级红黑:</label>
            ...
            <div class="layui-form-item">
                ...
                <label class="layui-form-label" style="width: 295px">备注:</label>
                <div class="layui-input-inline">
