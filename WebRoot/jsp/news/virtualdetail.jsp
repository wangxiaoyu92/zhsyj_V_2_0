...
<%@ page import="com.zzhdsoft.siweb.entity.Bord,com.zzhdsoft.siweb.entity.Fj,java.util.*" %>
<%
...
%>
<%
	Bord news = request.getAttribute("news")==null?null:(Bord)request.getAttribute("news");
	Bord preNews = request.getAttribute("preNews")==null?null:(Bord)request.getAttribute("preNews");
	Bord nextNews = request.getAttribute("nextNews")==null?null:(Bord)request.getAttribute("nextNews");
%>
<!DOCTYPE html>
<html>
<head>
