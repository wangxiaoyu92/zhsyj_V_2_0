...
//            }
        ...
        function uploadFuJian() {
            ...
            parent.sy.modalDialog({
                ...
                var v_retObj = parent.sy.getWinRet(dialogID);
...
<form class="layui-form" id="fm" method="post">
    ...
    <table class="layui-table" style="width: 99%;" lay-skin="nob">
        <tr>
            <td style="text-align:right;width: 120px"><font class="myred">*</font>检测机构名称:</td>
    ...
    <%-- <table class="layui-table" lay-skin="nob">
         ...
         <tr>
             <td style="text-align:right;">
                 <nobr><font class="myred">*</font>健康证发证日期:</nobr>
             </td>
             <td><input class="layui-input" id="ryjkzfzrq" name="ryjkzfzrq" lay-verify="required"></td>
             <td style="text-align:right;">
                 <nobr><font class="myred">*</font>健康证有效截止日期:</nobr>
             </td>
             <td><input class="layui-input" id="ryjkzyxjzrq" name="ryjkzyxjzrq" lay-verify="required"></td>
         </tr>
         <tr>
             <td style="text-align:right;">
                 <nobr>人员健康证:</nobr>
