...
$(function() {
	...
	layui.use(['form', 'table', 'layer', 'element', 'laydate'], function () {
		...
		table.render({
			elem: '#docTable'
			, url: basePath + '/oaeamil/queryOaemailGet'
			, page: true // 展示分页
			, limit: 10 // 每页展示条数
			...
			, cols: [[
                {field:'emailcontent',title:'站内信内容',align:'center',width:500, event: 'trclick',
                    templet: function (d) {
                    return '<a  href="javascript:show(\'' + d.oaemailid + '\',\'' + d.oaemailmanid + '\')" lay-event="detail">'  + '<span style="color:blue;">' + d.emailcontent + '</span></a>'
                    }
                }
    ...
    function show(oaemailid,oaemailmanid) {
        url=basePath + 'oaeamil/emailsdFormIndex?op=view&oaemailid=' + oaemailid+ '&oaemailmanid='+oaemailmanid
        sy.modalDialog({
            type: 2 // 0（信息框，默认）1（页面层）2（iframe层）3（加载层）4（tips层）
            , area: ['100%', '100%'] //
...
<div class="layui-fluid">
	...
	<div class="layui-margin-top-15">
		<div class="layui-btn-group demoTable">
			<button class="layui-btn " data-type="showPcom" data="btn_showPcom">回复站内信</button>
		</div>
