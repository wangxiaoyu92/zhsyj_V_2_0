        ...
        $(function () {
            ...
            layui.use(['form', 'layer', 'laydate', 'layedit'], function () {
                ...
                form.on('select()', function (data) {
                    var lw = $("#lwjg").val();
                    var lwold = $("#lwjgold").val();
                    var swzbhold = $("#swzbhold").val();
                    if (lw == lwold) {
                        $("#swzbh").val(swzbhold);
                        $("#writing3").val($("#writing4").val());
                    } else {
                        $.ajax({
                            type: 'POST',
...
//                                $('#archivecontent').val(mydata.archivecontent);
                                ...
                                $('#swzbhold').val(mydata.swzbh);
                                $('#lwjgold').val(mydata.lwjg);
                                $('#writing4').val(mydata.writing3);
        ...
        function fj() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {fjwid: '<%=v_arcid%>', fjtype:'GWZWFJ'},
                async: false,
                success: function (result) {
                    var mydata = result.data;
    ...
    <div region="center" style="overflow: hidden;" border="false">
        <form id="fm" class="layui-form" method="post">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label" style="width: 90px">来文机关:</label>

                <div class="layui-input-inline" style="width: 250px">
                    <select name="lwjg" id="lwjg" autocomplete="off"></select>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label" style="width: 90px">收文总编号:</label>

                <div class="layui-input-inline" style="width: 250px">
                    <input type="text" id="swzbh" name="swzbh"
                           autocomplete="off" class="layui-input">
                    <input id="swzbhold" name="swzbhold" type="hidden"/>
                    <input id="lwjgold" name="lwjgold" type="hidden"/>
                    <input id="writing4" name="writing4" type="hidden"/>
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 650px">
                    <textarea placeholder="请输入内容" class="layui-textarea" id="archiveremark"
                              name="archiveremark"></textarea>
                </div>
            </div>
