...
<head>
	...
	<script type="text/javascript">
        ...
        var v_sw = [{"id":"1","text":"办公室"},{"id":"2","text":"食安办"}];
        $(function () {
            var name='<%=name%>';
                    ...
                    $.post(basePath + '/egovernment/archive/addArchive?', formData, function (result) {
                        ...
                        if (result.code == "0") {
                            ...
                            if(sw=='1') {
                                ...
                                var v_url = encodeURI(encodeURI("<%=basePath%>workflow/beginWfprocessnew?" +
                                    "ywbh=" + ywbh +
                                    "&comdm=" + comdm +
                                    "&commc=" + commc +
                                    "&yewumcpym=" + yewumcpym +
    ...
    <div region="center" style="overflow: hidden;" border="false">
        <form id="fm" class="layui-form" method="post">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label" style="width: 90px">收文机关:</label>

                <div class="layui-input-inline" style="width: 250px">
                    <select name="sw" id="sw" autocomplete="off" lay-verify="required"></select>
                </div>
            </div>
            <div class="layui-form-item">
