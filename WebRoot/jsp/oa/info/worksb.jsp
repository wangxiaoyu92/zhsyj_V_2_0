        ...
        $(function() {
            ...
            layui.use(['form', 'table', 'layer', 'element'], function () {
                ...
                table.render({
                    ...
                    , cols: [[
                        {field: 'content', width: 250, title: '工作上报内容', event: 'trclick'}
                        , {field: 'time', width: 250, title: '工作上报时间', event: 'trclick'}
                        , {field: 'cyry', width: 250, title: '向谁上报', event: 'trclick'}
                    ]]
	...
	<script type="text/javascript">
        ...
        function showInfo(infoid) {
            sy.modalDialog({
                title: '查看工作上报'
                , area: ['100%', '100%']
                , content: basePath + 'work/task/worksbeditForm?op=view&worksbid=' + infoid
                , btn: ['关闭']
            });
        }
