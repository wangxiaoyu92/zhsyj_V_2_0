...
//                            $('#archivecontent').val(mydata.archivecontent);
                    ...
                    if ('<%=op%>' == 'view') {
                        ...
                        $('#archiveremark').attr('readonly', 'readonly');
                        $('input').attr('disabled', 'true');
                        $('#messagetype').attr('disabled', true);
                        $('#archivecontent').attr('disabled', true);
...
<div class="layui-table">
    <div region="center" style="overflow: hidden;" border="false">
        <form id="fm" class="layui-form" method="post">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label" style="width: 90px">发文:</label>
                ...
                <label class="layui-form-label" style="width: 60px">安食药监(</label>
                <div class="layui-input-inline" style="width: 130px">
                    <input type="text" id="writing2" name="writing2"
                           autocomplete="off" class="layui-input" >
