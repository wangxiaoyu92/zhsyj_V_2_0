...
$(function() {
	layui.use(['form', 'table', 'layer', 'element', 'laydate'], function () {
        ...
        var othertableid='<%=oataskid%>'
		table.render({
			elem: '#docTable'
			, url: basePath + '/work/task/queryhfsTaskZJ?othertableid='+othertableid
			, page: true // 展示分页
			, limit: 10 // 每页展示条数
			...
			, cols: [[
				{field: 'replycontent', width: 500, title: '回复内容', event: 'trclick'}
				, {field: 'aae036', width: 150, title: '回复时间', event: 'trclick'}
				, {field: 'aae011', width: 200, title: '回复人', event: 'trclick'}
		...
		table.on('tool(tableFilter)', function (obj) {
			...
			if (obj.event === 'trclick') { // 选中行
				if (selectTableDataId != data.oataskid) {
					...
					selectTableDataId = data.oataskid;
				} else { // 再次选中清除样式
	...
	function showDoc(data) {
        var oamatterdynamicid=data.oamatterdynamicid;
        var replycontent=data.replycontent;
        url=basePath + 'work/task/hfForm?op=view&oamatterdynamicid=' + oamatterdynamicid+ '&replycontent='+replycontent
...
<div class="layui-fluid">
	...
	<div class="layui-margin-top-15" style="width: 850px">
