...
<script type="text/javascript">
	...
	$(function() {
        layui.use(['form', 'layer', 'laydate'], function () {
            ...
            form.render();
            fjqt();
            var url = basePath + '/oaeamil/addOareport';
       ...
       if ($('#oareportid').val().length > 0) {
            $.post(basePath + '/oaeamil/queryOareportSendDTO', {
...
<div class="layui-table">
	<div region="center" style="overflow: hidden;" border="false">
		<form id="fm" class="layui-form" action="">
			...
			<div class="layui-form-item">
				<label class="layui-form-label"><font class="myred">*</font>工作上报内容:</label>
				<div height="100px" class="layui-input-inline" style="width: 650px">
					<textarea class="layui-textarea" id="reportcontent" name="reportcontent" cols="20" lay-verify="required"
							  rows="3"></textarea>
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				<label class="layui-form-label"><font class="myred">*</font>收件人:</label>
				<div class="layui-input-inline">
