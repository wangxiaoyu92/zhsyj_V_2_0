...
<% 
	...
	String oareportid = StringHelper.showNull2Empty(request.getParameter("oareportid"));
	String oareportmanid = StringHelper.showNull2Empty(request.getParameter("oareportmanid"));
	String op = StringHelper.showNull2Empty(request.getParameter("op"));
%>
<!DOCTYPE html>
<html>
<head>
<title>工作上报收件管理</title>
...
<script type="text/javascript">
	...
	$(function() {
       ...
       if ($('#oareportid').val().length > 0) {
            $.post(basePath + '/oaeamil/queryOareportGetDTO', {
                    oareportid: $('#oareportid').val()
                },
                function (result) {
                    if (result.code == '0') {
                        var mydata = result.data;
                        $('#reportcontentold').val(mydata.reportcontent);
    ...
    function fjqt() {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $.ajax({
                    type: 'POST',
                    url: basePath + '/oaeamil/updateoareportman',
                    dataType: 'json',
                    data: {oareportmanid: '<%=oareportmanid%>'
                    },
                    async: false,
                    success: function (result) {
                    }
		...
		<form id="fm" class="layui-form" action="">
			<div class="layui-form-item">
				<div class="layui-input-inline">
					<input type="hidden" id="oareportid" name="oareportid"  style="width: 300px" value="<%=oareportid%>"
			...
			<div class="layui-form-item">
				<div class="layui-input-inline">
					<input type="hidden" id="oamatterdynamicid" name="oamatterdynamicid"  style="width: 300px" value="<%=id%>"
						   class="layui-input layui-bg-gray">
					<input type="hidden" id="othertableid" name="othertableid"  style="width: 300px" value="<%=oareportid%>"
						   class="layui-input layui-bg-gray">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div height="100px" class="layui-input-inline" style="width: 650px">
					<textarea class="layui-textarea" id="reportcontentold" name="reportcontentold" cols="20" lay-verify="required"
							  rows="3"></textarea>
				</div>
			</div>
			<div class="layui-form-item">
