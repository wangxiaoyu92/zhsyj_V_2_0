...
<div class="layui-layout-body">
    ...
    <div class="layui-body" style="margin-left: 55px; width: 80%;margin-top: 10px;">
        <div class="lay-row" >
            <div class="layui-col-md12">
                <form class="layui-form" id="myqueryform">
                    <table class="layui_table" style="margin-bottom: 10px">
                        <tr>
                            <td>用户汉字描述:</td>
        ...
        <div class="lay-row">
            <div class="layui-col-md5">
                <div class="layui-collapse">
                    <h2 class="layui-colla-title">请选择用户</h2>
        ...
        <div class="lay-row" >
            <div class="layui-col-md1">
                <div class="layui-btn-group demoTable" style="padding: 50px 0px 0px 10px">
                    <ck:permission biz="addToSelectGrid">
                        <button class="layui-btn" data-type="addToSelectGrid"style="margin-top: 10px"
                                data="btn_addToSelectGrid">>
                        </button>
                    </ck:permission>
                    <ck:permission biz="mydeleterow">
                        <button class="layui-btn" data-type="mydeleterow"style="margin-top: 10px"
                                data="btn_mydeleterow"><
                        </button>
                    </ck:permission>
                </div>
            </div>
            ...
            <div class="layui-col-md6">
                <div class="layui-collapse">
                    <%--<div class="layui-colla-item">--%>
                        <h2 class="layui-colla-title">已选择的用户</h2>
