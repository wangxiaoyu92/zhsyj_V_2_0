...
<head>
    ...
    <script type="text/javascript">
        //定义全局变量父子关系类别
        var b_parentchildlb="moban";
        //定义全局变量父子关系类别名称
        var b_parentchildlbmc="通用父子关系模板";
        var treeObj;
        ...
        var setting2={
            ...
            async: {
                enable: true, //启用异步加载
                url: basePath + '/pub/pub/queryParentchildTree?parentchildlb='+b_parentchildlb+'&parentchildlbmc='+b_parentchildlbmc,  //调用后台的方法
        ...
        $(function() {
            ...
            layui.use(['form', 'table', 'element', 'laydate', 'layer'], function () {
                ...
                var url = basePath + '/pub/pub/saveParentchild?parentchildlb='+b_parentchildlb+'&parentchildlbmc='+b_parentchildlbmc;
            ...
            <div class="layui-colla-item" style="width:100%">
                ...
                <div class="layui-colla-content layui-show">
                    <form class="layui-form" id="fm">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label" style="width: 100px">属性1:</label>
                            <div class="layui-input-inline" style="width: 750px">
                                <input type="text" id="sx1" name="sx1"
                                       class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label" style="width: 100px">属性2:</label>
                            <div class="layui-input-inline" style="width: 750px">
                                <input type="text" id="sx2" name="sx2"
                                       class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label" style="width: 100px">属性3:</label>
                            <div class="layui-input-inline" style="width: 750px">
                                <input type="text" id="sx3" name="sx3"
                                       class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label" style="width: 100px">属性4:</label>
                            <div class="layui-input-inline" style="width: 750px">
                                <input type="text" id="sx4" name="sx4"
                                       class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label" style="width: 100px">属性5:</label>
                            <div class="layui-input-inline" style="width: 750px">
                                <input type="text" id="sx5" name="sx5"
                                       class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label" style="width: 100px">属性6:</label>
                            <div class="layui-input-inline" style="width: 750px">
                                <input type="text" id="sx6" name="sx6"
                                       class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label" style="width: 100px">属性7:</label>
                            <div class="layui-input-inline" style="width: 750px">
                                <input type="text" id="sx7" name="sx7"
                                       class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label" style="width: 100px">属性8:</label>
                            <div class="layui-input-inline" style="width: 750px">
                                <input type="text" id="sx8" name="sx8"
                                       class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label" style="width: 100px">属性9:</label>
                            <div class="layui-input-inline" style="width: 750px">
                                <input type="text" id="sx9" name="sx9"
                                       class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label" style="width: 100px">属性10:</label>
                            <div class="layui-input-inline" style="width: 750px">
                                <input type="text" id="sx10" name="sx10"
                                       class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
