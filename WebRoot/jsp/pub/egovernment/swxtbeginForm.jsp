    ...
    <script type="text/javascript">
        ...
        function tijiaoliucheng() {
            ...
            if (v_transname == '请示') {
                ...
                v_url = encodeURI("<%=basePath%>/egovernment/archive/updateArchive?archiveid=<%=v_ajdjid%>&archivestate=1");
            }else  if (v_transname == '批示'){
                $.ajax({
                    type: 'POST',
                    url: basePath + '/workflow/queryWfywlcuser',
                    dataType: 'json',
                ...
                var v_url2 = encodeURI(encodeURI("<%=basePath%>workflow/doWfswprocess?ywlcid=<%=v_ywlcid%>&transval=" + v_transval + "&shifouTongguo=" + v_shifouTongguo + "&ywlcuserid=" + cyryid + "&transname=" + v_transname + "&transyy=" + v_transyy + "&time=" + new Date().getMilliseconds()));
...
<form class="layui-form" action="" id="fawen">
 ...
 <div class="layui-input-inline">
     ...
     <select name="lwjg" id="lwjg">
        ...
        <tr>
            <td style="text-align:center;width: 8%">
                <span class="font_main"><br/><br/>请<br/><br/><br/>示</span><br/><br/><br/>
            </td>
            <td colspan="6">
                <span id="fenban"></span>
            </td>
