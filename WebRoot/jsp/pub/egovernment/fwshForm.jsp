...
<jsp:include page="${contextPath}/inc.jsp"></jsp:include>
	<script type="text/javascript">
        var v_fwtype = [{"id":"0","text":"局机关"},{"id":"1","text":"办公室"},{"id":"2","text":"综合科"},{"id":"3","text":"法规科"},{"id":"4","text":"食品生产监管科"},{"id":"5","text":"食品流通监管科"},{"id":"6","text":"餐饮食品监管科"},{"id":"7","text":"药化监管科"},{"id":"8","text":"医疗器械监管科"},{"id":"9","text":"财务装备科"},{"id":"10","text":"人事科"},{"id":"11","text":"稽查支队"},{"id":"12","text":"审评中心"}];
        $(function () {
            intSelectData("org", v_fwtype);
            gongwen();
            $('#org').change(function(){
                var org=$('#org').val();
                if(org=='1'){
...
function tijiaoliucheng(){
    ...
    if(v_transname1==1){
        ...
        lwjg="3"+$("#org").val();
    }else if(v_transname1==2){
        writing1=$("#writing4").val();
        writing2=$("#writing5").val();
        writing3=$("#writing6").val();
        lwjg="4"+$("#org").val();
    }else{
        writing1=$("#writing7").val();
        writing2=$("#writing8").val();
        writing3=$("#writing9").val();
        lwjg="5"+$("#org").val();
	}
    var cyryid = "";
    if(v_transname=='发文'){
     ...
     <table width="100%" height="60px;">
      <tr>
        ...
        <td width="88%" align="left">
		 ...
		 <tr>
			 <td width="15%" align="right">请选择科室：</td>
			 <td width="88%" align="left">
				 <div class="layui-input-inline" style="width: 250px">
					 <select name="org"  id="org" autocomplete="off" ></select>
				 </div>
			 </td>
		 </tr>
		 <tr>
			 <td width="15%" align="right"><input type="radio" name="transname1" <%=v_nextchecked%> id="transname3"  value="3" style="cursor: pointer;"/>发文编号1： </td>
			 <td width="88%" align="left">
				 <div class="layui-form-item">
					 ...
					 <div class="layui-input-inline" style="width: 130px">
						 ...
						 <input type="text" id="writing7" name="writing7"
					 ...
					 <div class="layui-input-inline" style="width: 130px">
						 <input type="text" id="writing8" name="writing8"
								autocomplete="off" class="layui-input" >
					 ...
					 <div class="layui-input-inline" style="width: 130px">
						 <input type="text" id="writing9" name="writing9"
								autocomplete="off" class="layui-input" >
		 ...
		 <tr>
			 <td width="15%" align="right"><input type="radio" name="transname1"  id="transname1"  value="1" style="cursor: pointer;"/>发文编号2： </td>
			 <td width="88%" align="left">
				 <div class="layui-form-item">
       ...
       <tr>
		 <tr>
			 <td width="15%" align="right"><input type="radio" name="transname1"  id="transname2"  value="2" style="cursor: pointer;"/>发文编号3： </td>
			 <td width="88%" align="left">
				 <div class="layui-form-item">
