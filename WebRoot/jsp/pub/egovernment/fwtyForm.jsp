...
function tijiaoliucheng(){
	...
	if(v_transname=='合法性审查'){
        ...
        $.ajax({
            type: 'POST',
            url: basePath + '/workflow/queryWfywlcnbuser',
            dataType: 'json',
            data: {
                ywbh: '<%=v_ywbh%>',
                nodeid: 43
