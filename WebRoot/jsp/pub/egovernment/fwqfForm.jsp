...
//                    alert(result.size);
            ...
            $.ajax({
                ...
                success:function(result){
                    ...
                    var div1 = document.getElementById("xuanzeliuxiang");
      ...
      <tr>
        ...
        <td width="88%" align="left">
	     <div id="xuanzeliuxiang">
			...
			<div id="b">
				<input type="radio" name="transname1" <%=v_nextchecked%> id="transname1"  value="主要领导审批" style="cursor: pointer;"/>主要领导审批
			</div>
        </td>
      </tr>
