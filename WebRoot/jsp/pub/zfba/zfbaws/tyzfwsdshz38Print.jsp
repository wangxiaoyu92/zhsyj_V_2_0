	...
	<div align="center" id="page1">
		<p class="p1">
			...
			<p class="p5" style="text-align: right;">
				   <span><%if(!"".equals(localZfwsajlydjbDTO.getSdhzgzrq())&&localZfwsajlydjbDTO.getSdhzgzrq().length()>=10){ %>
			<%=localZfwsajlydjbDTO.getSdhzgzrq().substring(0,4) %>年
			<%=localZfwsajlydjbDTO.getSdhzgzrq().substring(5,7) %>月
			<%=localZfwsajlydjbDTO.getSdhzgzrq().substring(8,10) %>日
			<%}else{ %>
			  &nbsp;&nbsp;&nbsp;&nbsp;年&nbsp;&nbsp;&nbsp;&nbsp;月&nbsp;&nbsp;&nbsp;&nbsp;日
			<%} %></span>
				</p>
