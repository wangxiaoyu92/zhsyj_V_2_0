...
<div style="width: 210mm; margin: 0 auto;display: none">
	...
	-->
		...
		<div align="center" id="page<%=page_number%>">
			...
			<div align="right">
				<p class="p3">
					<span class="s2"><%=localZfwsajlydjbDTO.getAjlywsbh() %></span>
				</p>
			</div>
...
<p class="p61">
<span class="s2">当事人：</span><span class="wsty" style="width:525px;"><%=localZfwsajlydjbDTO.getAjlydsr() %></span>
</p>
<p class="p61">
<span class="s2">地址：</span><span class="wsty" style="width:398px;"><%=
					localZfwsajlydjbDTO.getAjlydz() %></span>
<span class="s2">邮编：</span><span class="wsty" style="width:97px;"><%=
					localZfwsajlydjbDTO.getAjlyyb() %></span>
</p>
<p class="p6">
<span class="s2">法定代表人（负责人）/自然人：</span><span class="wsty" style="width:158px;"><%=
					localZfwsajlydjbDTO.getAjlyfddbr() %></span>
<span class="s2">联系电话：</span><span class="wsty" style="width:148px;"><%=
					localZfwsajlydjbDTO.getAjlylxdh() %></span>
</p>
<p class="p7">
<span class="s2">法定代表人（负责人）/自然人身份证号码：</span>
<span class="wsty" style="width:308px;"><%=localZfwsajlydjbDTO.getAjlyfddbrsfzh()%></span>
</p>
<p class="p8">
<span class="s2">登记时间：</span>
<% if (!"".equals(localZfwsajlydjbDTO.getAjlydjsj())){%>
<span class="wsty" style="width:100px;text-align: center"><%=localZfwsajlydjbDTO.getAjlydjsj().substring(0, 4)%></span><span class="s2">年</span>
<span class="wsty" style="width:85px;text-align: center"><%=localZfwsajlydjbDTO.getAjlydjsj().substring(5, 7)%></span><span class="s2">月</span>
<span class="wsty" style="width:80px;text-align: center"><%=localZfwsajlydjbDTO.getAjlydjsj().substring(8, 10)%></span><span class="s2">日</span>
<span class="wsty" style="width:75px;text-align: center"><%=localZfwsajlydjbDTO.getAjlydjsj().substring(11, 13)%></span><span class="s2">时</span>
<span class="wsty" style="width:75px;text-align: center"><%=localZfwsajlydjbDTO.getAjlydjsj().substring(14, 16)%></span><span class="s2">分</span>
<%}else{%>
<span class="wsty" style="width:100px;text-align: center">年</span>
<span class="wsty" style="width:85px;text-align: center">月</span>
<span class="wsty" style="width:80px;text-align: center">日</span>
<span class="wsty" style="width:75px;text-align: center">时</span>
<span class="wsty" style="width:75px;text-align: center">分</span>
<%} %>
...
<p class="p10" style="text-indent: 2em;">
<span style="word-break: break-all; word-wrap:break-word;dispaly:inline-block;">
<%=SysmanageUtil.replaceStrChuLast(localZfwsajlydjbDTO.getAjlyjbqkjs()) %>
</span></p>
<p class="p10"></p>
<p class="p10"></p>
<p class="p10"></p>
...
<p class="p11"></p>
<p class="p12">
<span class="s2">附件：<%=localZfwsajlydjbDTO.getAjlyfj() %></span>
</p>
<p class="p13">
<span class="s2">                                  </span>
</p>
...
<p class="p3"  >
<span class="s2 s22">记录人：<%=localZfwsajlydjbDTO.getAjlyjlrqz() %>(签字)</span>
</p>
<p class="p3">
<span class="s2 s22" >
<% if (!"".equals(localZfwsajlydjbDTO.getAjlyjlrqzrq())){%>
	<%=localZfwsajlydjbDTO.getAjlyjlrqzrq().substring(0, 4)%>年
	<%=localZfwsajlydjbDTO.getAjlyjlrqzrq().substring(5, 7)%>月
	<%=localZfwsajlydjbDTO.getAjlyjlrqzrq().substring(8, 10)%>日
<%}else{ %>
&nbsp;&nbsp;年
&nbsp;&nbsp;月
&nbsp;&nbsp;日
...
<p class="p14">
<span style="word-break: break-all; word-wrap:break-word;dispaly:inline-block;">
<%=SysmanageUtil.replaceStrChuLast(localZfwsajlydjbDTO.getAjlyclyj()) %>
</span>
</p>
<p class="p14"></p>
<p class="p14">
...
<p class="p3">
<span class="s2 s22">负责人：<%=localZfwsajlydjbDTO.getAjlyfzr() %>(签字)   </span>
</p>
<p class="p3">
<span class="s2 s22">
<% if (!"".equals(localZfwsajlydjbDTO.getAjlyfzrqzsj())){%>
	<%=localZfwsajlydjbDTO.getAjlyfzrqzsj().substring(0, 4)%>年
	<%=localZfwsajlydjbDTO.getAjlyfzrqzsj().substring(5, 7)%>月
	<%=localZfwsajlydjbDTO.getAjlyfzrqzsj().substring(8, 10)%>日
<%}else{ %>
&nbsp;&nbsp;年
&nbsp;&nbsp;月
&nbsp;&nbsp;日
