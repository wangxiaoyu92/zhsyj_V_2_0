...
<%@ page import="com.zzhdsoft.mvc.GlobalConfig,com.zzhdsoft.utils.SysmanageUtil,com.askj.zfba.dto.Zfwsft13DTO"%>
...
<script type="text/javascript">
	...
	function myprint() {
		...
		//创建模态窗口
		var url="<%=basePath%>pub/wsgldy/ZfwsftIndexPrint";
...
<body class="b1 b2 zfwsbackgroundcolor">
	<form id="myform" method="post">
		...
		<div id="ft">
			...
			<div id="f2">
			<input name="ftyzrq" id="ftyzrq" class="Wdate"
			...
			<table>
				<tr align="right" style="height: 60px;">
					<td colspan=4 align="right">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="javascript:void(0);" id="printBtn" class="easyui-linkbutton"
