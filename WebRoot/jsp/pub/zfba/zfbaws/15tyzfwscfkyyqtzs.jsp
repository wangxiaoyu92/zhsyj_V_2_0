...
<%@ page import="com.zzhdsoft.mvc.GlobalConfig,com.zzhdsoft.utils.SysmanageUtil,com.askj.zfba.dto.Zfwscfkyyqtzs15DTO"%>
...
<%
	...
	if (request.getAttribute("mybean") != null) {
		dto = (Zfwscfkyyqtzs15DTO) request.getAttribute("mybean");
	}
%>
...
<div style="width: 210mm; margin: 0 auto">
	<body class="b1 b2 zfwsbackgroundcolor">
		<form id="myform" method="post">
			...
			<hr style="height:2px;border:none;border-top:2px solid #555555;" />
			<p class="p6">
				<span class="s2">根据《中华人民共和国行政强制法》第二十五条第一款的规定，由于 </span>
				<span class="s3"><input id="cfyqyy" name="cfyqyy" style="width: 280px;"value="${mybean.cfyqyy}" /></span>
				<span class="s2">（原因），我局决定对</span>
				<span class="s3"><input id="cfyqcfkyjdsbh" name="cfyqcfkyjdsbh" style="width: 280px;"
					value="${mybean.cfyqcfkyjdsbh}" /></span>
				<span class="s2">《查封（扣押）决定书》中所查封（扣押）的物品延长查封（扣押）期限，延长期限</span>
				<span class="s3"><input id="cfyqqz" name="cfyqqx" style="width: 80px;"value="${mybean.cfyqqx}" /></span>
				<span class="s2">日，自&times;年&times;月&times;日</span>
				<span class="s3"><input name="cfyqksrq" id="cfyqksrq" class="Wdate"
					onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"
					style="width: 135px;" value="${mybean.cfyqksrq}"> </span>
				<span class="s2">起延长至&times;年&times;月&times;日</span>
				<span class="s3"><input name="cfyqjsrq" id="cfyqjsrq" class="Wdate"
					onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"
					style="width: 135px;" value="${mybean.cfyqjsrq}"></span>
			...
			<p class="p11">
				<span class="s2"> &times;年&times;月&times;日 <input
					...
					onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"
					style="width: 175px;" value="${mybean.cfyqgzrq}"> </span>
			</p>  
			<p class="p7">
			   <span class="s2">当事人签字：<input  name="cfyqdsrqz" id="cfyqdsrqz" value="${mybean.cfyqdsrqz}" /></span>
			   <span>&times;年&times;月&times;日 <input name="cfyqdsrqzrq" id="cfyqdsrqzrq"  class="Wdate" 
					onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" 
					style="width: 175px;"  value="${mybean.cfyqdsrqzrq}" ></span> 
