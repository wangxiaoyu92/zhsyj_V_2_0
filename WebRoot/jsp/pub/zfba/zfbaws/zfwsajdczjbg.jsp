...
var  tcq='<%= aa027%>';
	...
	function myprint(){
			...
			var url="<%=basePath%>pub/wsgldy/zfwsajdczjbg9PrintIndex?ajdjid="+v_zfwslydjid+"&time="+new Date().getMilliseconds();
  ...
  // 关闭并刷新父窗口
	...
	<body class="b1 b2 zfwsbackgroundcolor">
	 <form id="myform" method="post">
		...
		<p class="p3">
			<span class="s2">案由:${mybean.ajdjay}</span>
		</p>
		<p class="p3">
			<span class="s2">当事人基本情况：<br/>
			<textarea class="easyui-validatebox bbtextarea"  data-options="required:true" id="dczjdsrjbqk" name="dczjdsrjbqk" style="width: 730px;height: 200px;">${mybean.dczjdsrjbqk}</textarea>
		...
		<p class="f1" style="float:right;">
			<span class="s2">                                              案件承办人：<input id="dczjajcbrqz" name="dczjajcbrqz" style="width:70px;"  class="easyui-validatebox bbtextarea" data-options="required:true"    value="${mybean.dczjajcbrqz}"/>
						<input id="dczjajcbrqz2" name="dczjajcbrqz2" style="width:70px;"  class="easyui-validatebox bbtextarea" data-options="required:true"    value="${mybean.dczjajcbrqz2}"/>
			（签字）</span>
		</p>
		...
		<p class="f2">
			<span class="s2" style="float:right;">                                                 &times;年&times;月&times;日：<input name="dczjajcbrqzrq" id="dczjajcbrqzrq"  class="Wdate easyui-validatebox bbtextarea"
				data-options="required:true" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"  style="width: 175px;"  value="${mybean.dczjajcbrqzrq}" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
		</p>
		</div>
		<p class="p7"></p>
			</div>
