...
<% 
    ...
    if (request.getAttribute("printbean") != null) {
    	localZfwsajyss3DTO = (Zfwsajyss3DTO) request.getAttribute("printbean");
    }	
%>
<html>
<head>
...
.p4{text-indent:3.1930556in;margin-right:0.06944445in;margin-top:0.108333334in;text-align:end;hyphenate:auto;font-family:仿宋_GB2312;font-size:10.5pt;margin-left:2in;}
...
.p6{text-indent:2em;margin-left:0.072916664in;text-align:justify;hyphenate:auto;font-family:仿宋_GB2312;font-size:10.5pt;line-height:1.5}
.p7{text-indent:0.29166666in;margin-top:0.21666667in;text-align:justify;hyphenate:auto;font-family:仿宋_GB2312;font-size:10.5pt;height:80px;}
...
.p9{margin-top:0.108333334in;text-align:justify;hyphenate:auto;font-family:仿宋_GB2312;font-size:10.5pt;margin-left:4.18in;}
...
.p111{text-indent:3.7916667in;margin-top:0.108333334in;text-align:justify;hyphenate:auto;font-family:仿宋_GB2312;font-size:10.5pt;margin-left:400px;}
.p12{margin-right:0.65625in;margin-top:0.108333334in;text-align:end;hyphenate:auto;font-family:仿宋_GB2312;font-size:10.5pt;margin-left:4.18in;}
...
function CreatePrintPage() {
	...
	LODOP.ADD_PRINT_HTML("240mm","20mm", "RightMargin:1.8cm","100mm",strBodyStyle+document.getElementById("footer").innerHTML);
...
<p class="p4">
<span class="s1"><%=localZfwsajyss3DTO.getZfwsbh()%></span>
</p>
<hr style="height:2px;border:none;border-top:2px solid #555555;" />
<p class="p5">
<span class="s3"><%=localZfwsajyss3DTO.getAjysbmmc()%>：</span>
</p>
<p class="p6">
<span class="s1"></span>
<span class="s3" style="word-wrap:break-word; word-break:normal;display: inline;"><%=SysmanageUtil.replaceStrChuLast(localZfwsajyss3DTO.getAjysms())%></span>
<span class="s1">一案，经调查，</span>
<span class="s3" style="word-wrap:break-word;word-break:normal;display: inline;"><%=SysmanageUtil.replaceStrChuLast(localZfwsajyss3DTO.getAjysysyy())%></span>
<span class="s1">（案件发生的时间、主要违法事实及移送原因），根据《中华人民共和国行政处罚法》第<%=localZfwsajyss3DTO.getAjysdjt().replace("\r\n","<br/>")%>条的规定，现移送你单位处理。案件处理结果请函告我局。</span>
</p>
<p class="p7"></p>
</div>
<div id="footer">
<p class="p8">
<span class="s1">附件：案情简介及有关材料<%=localZfwsajyss3DTO.getAjysclzs()%>件。                                             </span>
</p>
<p class="p111"></p>
<p class="p12">
...
<p class="p9">
<span class="s1"> 
<%=localZfwsajyss3DTO.getAjysrq().substring(0,4)%>年
<%=localZfwsajyss3DTO.getAjysrq().substring(5,7)%>月
<%=localZfwsajyss3DTO.getAjysrq().substring(8,10)%>日
</span>
</p>
<p class="p14">
