...
<head>
    ...
    <style type="text/css">
        ...
        .p4 {
            text-indent: -1.6041666in;
            margin-left: 1.6770834in;
            text-align: start;
            hyphenate: auto;
            font-family: 仿宋_GB2312;
            font-size: 10pt;
    ...
    <form id="myform" method="post">
        ...
        <p class="p3">
				<span class="s3">送达文书名称及文书编号：<input id="sdhzwsmcbh" name="sdhzwsmcbh"
                                                    style="width:500px;" class="easyui-validatebox bbtextarea"
                                                    data-options="required:false" value="${mybean.sdhzwsmcbh}"/></span>
        </p>
        <p class="p5"></p>
        <div id="fz">
            <p class="p3">
            ...
            <p class="p3">
					<span class="s3">送达人：<input id="sdhzsdr" name="sdhzsdr"
                                                style="width:100px;" class="easyui-validatebox bbtextarea"
                                                data-options="required:false" value="${mybean.sdhzsdr}"/></p>
            <p class="p3">
						<span class="s3">受送达单位（人）：<input id="sdhzssddwqz" name="sdhzssddwqz"
                                                         style="width:100px;" class="easyui-validatebox bbtextarea"
                                                         data-options="required:false" value="${mybean.sdhzssddwqz}"/>
            </p>
        </div>
        <div id="fy">
            <p class="p3">
						<span class="fr">送达地点：<input id="sdhzsddd" name="sdhzsddd"
                                                     style="width:100px;" class="easyui-validatebox bbtextarea"
                                                     data-options="required:false" value="${mybean.sdhzsddd}"/></span>
            </p>
        ...
        <p class="p5"></p>
        <p class="p5">
				<span class="s3">备注：<textarea class="easyui-validatebox bbtextarea" id="sdhzbz" name="sdhzbz"
