        ...
        <div align="right">
            <p class="p11">
				...
				<input type="text" style="width: 150px; text-align: left;" name="qzsqxzjgfzr"
                       id="qzsqxzjgfzr" <%=v_xzcfqzzxsqs_xzjgfzrqz_readonly %>
                       value="${mybean.qzsqxzjgfzr}">（签字）　</span>
            </p>
            <p class="p12">
