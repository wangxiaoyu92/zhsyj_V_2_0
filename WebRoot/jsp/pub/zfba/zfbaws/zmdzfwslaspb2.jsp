...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            if ($('#laspid').val() == "") {
                document.getElementById("ssss").value = "同意"
            }
    ...
    <form id="myform" method="post">
        ...
        <p class="p8">
				<span class="s2">经初步审查，当事人的行为涉嫌违反了
				 <input id="laspflfg" name="laspflfg" style="width: 450px;" value="${mybean.laspflfg}"/><input
                            type="button" style="color:blue;" value="选择" onclick="myselectPcyzdsz();">（法律法规名称及其条、款、项）
					的规定，申请予以立案。</span>
        </p>
        <p class="p10">
        ...
        <p class="p8">
				<span class="s2">建议本案由 <input id="laspjyzb" name="laspjyzb"
                                              style="width: 260px;" value="${mybean.laspjyzb}"/> 承办。</span>
            <span class="s2">由 <input id="laspjyxb" name="laspjyxb"
                                      style="width: 260px;" value="${mybean.laspjyxb}"/> 协办。</span><br>
        </p>
        <p class="p10">
				<span class="s2"> 承办部门负责人：<input id="laspcbbmfzr"
                                                 name="laspcbbmfzr" <%=v_laspb_laspcbbmfzr_readonly %>
                                                 style="width: 90px;" class="easyui-validatebox"
                                                 data-options="validType:'length[0,20]'"
        ...
        <p class="p10">
				<span class="s2"> 分管负责人：<input id="laspfgfzr"
                                               name="laspfgfzr" <%=v_laspb_laspfgfzr_readonly %> style="width: 90px;"
