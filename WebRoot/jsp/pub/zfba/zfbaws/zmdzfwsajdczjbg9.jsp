...
<%@ page
        import="com.zzhdsoft.mvc.GlobalConfig,com.zzhdsoft.utils.SysmanageUtil,com.askj.zfba.dto.Zfwsajdczjbg9DTO,com.zzhdsoft.siweb.entity.sysmanager.Sysuser" %>
...
<div style="width: 210mm; margin: 0 auto">
    ...
    <form id="myform" method="post">
        ...
        <p class="p3">
			...
			<textarea class="easyui-validatebox bbtextarea" data-options="required:true" id="dczjdsrjbqk"
                      name="dczjdsrjbqk" style="width: 730px;height: 200px;">${mybean.dczjdsrjbqk}</textarea>
			<br/>（当事人是自然人的，应写明当事人姓名、性别、年龄、身份证号码、工作单位、住所等；当事人是法人或者非法人企业及其分支机构<br/>&nbsp;的，写明该法人或者非法人企业及其分支机构的名称、地址、法定代表人或负责人姓名、职务等）</span>
        </p>
        <p class="p4"></p>
        <p class="p4">
			<span class="s2">违法事实：<br/>
		       <textarea class="easyui-validatebox bbtextarea" data-options="required:true" id="dczjwfss"
                         name="dczjwfss" style="width: 730px;height: 200px;">${mybean.dczjwfss}</textarea>
			</span>
        </p>
        <p class="p4"></p>
        <p class="p4"></p>
        ...
        <p class="p4"></p>
        <p class="p4">证据材料：<br/>
            <textarea class="easyui-validatebox bbtextarea" data-options="required:true" id="dczjzjcl" name="dczjzjcl"
                      style="width: 730px;height: 200px;">${mybean.dczjzjcl}</textarea>
        </p>
        <p class="p4"></p>
        <p class="p4"></p>
        <p class="p4"></p>
        <p class="p4"></p>
        <p class="p4">处罚依据：<br/>
            <textarea class="easyui-validatebox bbtextarea" data-options="required:true" id="dczjcfyj" name="dczjcfyj"
                      style="width: 730px;height: 200px;">${mybean.dczjcfyj}</textarea>
        </p>
        <p class="p4"></p>
        <p class="p4"></p>
        <p class="p4"></p>
        ...
        <p class="p4"></p>
        <p class="p4">处罚建议：<br/>
            <textarea class="easyui-validatebox bbtextarea" data-options="required:true" id="dczjcfjy" name="dczjcfjy"
                      style="width: 730px;height: 200px;">${mybean.dczjcfjy}</textarea>
        </p>
        <p class="p5"></p>
        <p class="p6">
            <span class="s2">                                                  </span>
        ...
        <div id="pd1">
            <p class="f1" style="float:right;">
                <span class="s2">  案件承办人1：<input id="dczjajcbrqz" name="dczjajcbrqz" style="width:70px;"
                                                 class="easyui-validatebox bbtextarea" value="${mybean.dczjajcbrqz}"/>（签字）</span>
                <br>
                <span class="s2">  案件承办人2：<input id="dczjajcbrqz2" name="dczjajcbrqz2" style="width:70px;"
                                                 class="easyui-validatebox bbtextarea" value="${mybean.dczjajcbrqz2}"/>（签字）</span>
            </p>
            <p style="clear:both;"></p>
            <p class="f2">
			<span class="s2" style="float:right;">                                                 &times;年&times;月&times;日：<input
                    name="dczjajcbrqzrq" id="dczjajcbrqzrq" class="Wdate easyui-validatebox bbtextarea"
                    onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" style="width: 175px;"
                    value="${mybean.dczjajcbrqzrq}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</span>
            </p>
        </div>
        <p class="p7"></p>
