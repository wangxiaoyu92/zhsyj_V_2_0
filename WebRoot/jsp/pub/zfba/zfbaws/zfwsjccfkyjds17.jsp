...
<%@ page
	import="com.zzhdsoft.mvc.GlobalConfig,com.zzhdsoft.utils.SysmanageUtil,com.askj.zfba.dto.Zfwsjccfkyjds17DTO"%>
...
var v_ajdjajly = <%=SysmanageUtil.getAa10toJsonArray("AJDJAJLY")%>;
	...
	function myprint() {
		...
		var url = "<%=basePath%>pub/wsgldy/Zfwsjccfkyjds17IndexPrint?ajdjid="+v_zfwslydjid+"&zfwsqtbid="+v_jccfkyjdsid+"&time="+new Date().getMilliseconds();
...
<body class="b1 b2 zfwsbackgroundcolor">
	<form id="myform" method="post">
		...
		<input id="jccfkyjdsid" name="jccfkyjdsid" type="hidden"
			...
			<p class="p3">
			<span class="s2"><input id="jckywsbh" name="jckywsbh" style="width:200px;" class="easyui-validatebox bbtextarea" value="${mybean.jckywsbh}" /></span>
			</p>
			...
			<p class="p5">
			<span class="s2">我局于<input name="jckykyrq" id="jckykyrq" class="Wdate easyui-validatebox bbtextarea"
				onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"
				style="width: 175px;" value="${mybean.jckykyrq}"/>，以<input style="width:200px;" name="jckykybh" value="${mybean.jckykybh}"/>《查封（扣押）决定书》对
				  <input style="width:200px;" name="jckywpqdbh" value="${mybean.jckywpqdbh}"/>《查封（扣押）物品清单》所列物品予以查封（扣押），现根据
				  <input id="jckydjx" name="jckydjx" style="width:400px;" class="easyui-validatebox bbtextarea"  value="${mybean.jckydjx}" />的规定，予以全部（或部分）解除查封（扣押）。</span>
			</p>
			<p class="p6"></p>
			<p class="p6">
			<span class="s2">附件：<a href="#"><input name="jckyfj" style="width:200px;" value="${mybean.jckyfj}"/>《解除查封（扣押）物品清单》</a></span>
			</p>
			<p class="p6"></p>
			<p class="p6"></p>
			<p class="p6"></p>
			...
			<p class="p12">
			<span class="s2">                                                         
			&times;年&times;月&times;日:<input name="jckygzrq" id="jckygzrq" class="Wdate easyui-validatebox bbtextarea"
				 onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"
