    ...
    <form id="myform" method="post">
        ...
        <p class="p10">
				<span class="s2"> 承办部门负责人：<input id="laspcbbmfzr"
                                                 name="laspcbbmfzr" <%=v_laspb_cbbmfzr_readonly %> style="width: 90px;"
        ...
        <p class="p12">
            ...
            <span><input id="laspspyj" name="laspspyj" <%=v_laspb_spyj_readonly %> value="${mybean.laspspyj}"
        ...
        <p class="p10">
				<span class="s2"> 分管负责人：<input id="laspfgfzr"
                                               name="laspfgfzr" style="width: 90px;" <%=v_laspb_spyj_readonly %>
                                               class="easyui-validatebox"
                                               data-options="validType:'length[0,20]'"
