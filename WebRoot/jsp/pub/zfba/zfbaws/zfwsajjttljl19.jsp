...
<%@ page
	import="com.zzhdsoft.mvc.GlobalConfig,com.zzhdsoft.utils.SysmanageUtil,com.askj.zfba.dto.Zfwsajjttljl19DTO"%>
	...
	<body class="b1 b2 zfwsbackgroundcolor">
		<form id="myform" method="post">
			...
			<p class="p4">
				...
				<span class="s3"><input  id="jttldsr" name="jttldsr" style="width: 260px;"
						value="${mybean.jttldsr}" /> 
				</span>
			</p>
			<p class="p4">
				...
				<span class="s3"><input	name="jttlsj" id="jttlsj" class="Wdate"
					...
					style="width: 175px;"
					<%if(localZfwsajjttljl19DTO.getJttlsj() != null){ %> 
					value="${mybean.jttlsj}"<%} else { %>
					value="<%=SysmanageUtil.getDbtimeYmd()%>"<%} %>></span>
			...
			<p class="p4">
				<span class="s2">主持人：</span>
				<span class="s3"><input  id="jttlzcrqz" name="jttlzcrqz" style="width: 100px;"
						    value="${mybean.jttlzcrqz}" />（签字）</span> 
				<span class="s2">记录人：</span>
				<span class="s3"><input  id="jttljlrqz" name="jttljlrqz" style="width: 100px;"
						    value="${mybean.jttljlrqz}" />
					 （签字） </span>
			</p>
			<p class="p4">
				<span class="s2">参加人员：</span>
				<span class="s3"><input  id="jttlcjryqz" name="jttlcjryqz" style="width: 100px;"
