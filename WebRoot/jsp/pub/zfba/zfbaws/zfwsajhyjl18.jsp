...
<%@ page
	import="com.zzhdsoft.mvc.GlobalConfig,com.zzhdsoft.utils.SysmanageUtil,com.askj.zfba.dto.Zfwsajhyjl18DTO"%>
		...
		<form id="myform" method="post">
			...
			<p class="p5">
				<span class="s2">合议时间： <input name="hysj" id="hysj" class="Wdate"
					...
					style="width: 175px;" 
					<%if(localZfwsajhyjl18DTO.getHysj() == null || "".equals(localZfwsajhyjl18DTO.getHysj())){ %>
						value="<%=SysmanageUtil.getDbtimeYmd()%>"
					<%}else{ %>value="${mybean.hysj}"<%} %>>
			...
			<p class="p4">
				证据材料：
				<textarea id="hyzjcl" name="hyzjcl" 
					style="width: 770px;height: 150px;">${mybean.hyzjcl}</textarea>
			</p>
			<p class="p4">
				违法行为等次：
				<textarea id="hywfxwdc" name="hywfxwdc" 
					style="width: 770px;height: 100px;">${mybean.hywfxwdc}</textarea>
			</p>
			<p class="p4">
				违反条款：
				<textarea id="jytk" name="jytk" 
					style="width: 770px;height: 100px;">${mybean.jytk}</textarea>
			</p>
			<p class="p4">
				讨论记录：
			...
			<p class="p4">
				合议意见：
				<textarea class="bbtextarea" id="hyyj" name="hyyj" 
