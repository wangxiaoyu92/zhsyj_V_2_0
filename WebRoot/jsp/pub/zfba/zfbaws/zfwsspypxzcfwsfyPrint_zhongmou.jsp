...
<div style="width: 210mm; margin: 0 auto;display: none">
	   <body class="b1 b2">
			...
			<p class="p2" >
				<span class="s1">（
				<%if(dto.getFytitle() != null && !"".equals(dto.getFytitle())){ %>
				<span class="s1"><%=dto.getFytitle()%></span><%} else {%>
				<span style="border-bottom: 0px solid  white-space;width: 150px;display: inline-block;"></span><%} %>
				）副页</span>
			</p>
			<p class="p3" align="right">
				<span class="s3">
			第<input id="fydjy" name="fydjy" style="width: 50px;" value="<%=dto.getFydjy()%>" />页，
			共 <input id="fygjy" name="fygjy" style="width: 50px;" value="<%=dto.getFygjy()%>" />页
		    </span>
			</p>
			<p class="p4"></p>
			<p class="p4"></p>
		...
		<textarea class="easyui-validatebox bbtextarea" id="fycontent" name="fycontent"
				  style="width: 770px;height: 400px;" >${mybean.fycontent}</textarea>
			<hr style="height:2px;border:none;border-top:2px solid #555555;" />
 	</div>
	</body></div>
</html>
