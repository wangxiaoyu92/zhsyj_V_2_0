...
<%@ page
	import="com.zzhdsoft.mvc.GlobalConfig,com.zzhdsoft.utils.SysmanageUtil,com.askj.zfba.dto.Zfwsxxdjbcwptzs10DTO"%>
...
var mygrid;
	...
	function myprint(){
			...
			var url="<%=basePath%>pub/wsgldy/zfwsxxdjbcwptzs10PrintIndex?xxdjbcwptzsid="
				+v_id+"&ajdjid="+v_ajdjid+"&time="+new Date().getMilliseconds();
		//创建模态窗口
...
<body class="b1 b2 zfwsbackgroundcolor">
	<form id="myform" method="post">
		...
		<p class="p5">
			<span class="s2">&nbsp;&nbsp;&nbsp;&nbsp;根据《中华人民共和国行政处罚法》第三十七条第二款规定，我局决定对你(单位)的有关物品［见</span>
			<span class="s2"><input id="xztzwpqdwsbh" name="xztzwpqdwsbh"
				style="width:200px;" value="${mybean.xztzwpqdwsbh}" />:
			</span>
			<span class="s2">《先行登记保存物品清单》］予以登记保存。在此期间，不得损毁、销毁或者转移。</span>
		</p>
		<p class="p6"></p>
		<p class="p7">
		...
		<p class="p7">
			<span class="s2">保存期限：<input id="xztzbcqx" name="xztzbcqx"
				style="width:550px;" value="${mybean.xztzbcqx}" />七日</span>
		</p>
		<p class="p6">
			<span class="s2"> </span>
		</p>
		...
		<div align="right">
			...
			<p class="p3">
				<span class="s2"> &times; 年&times;月&times;日:<input
					...
					style="width: 175px;"
					<%if(dto.getXztzgzrq() != null && !"".equals(dto.getXztzgzrq())){ %>
					value="${mybean.xztzgzrq}" 
