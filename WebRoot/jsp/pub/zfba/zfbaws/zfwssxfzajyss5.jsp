...
var v_ajdjajly = <%=SysmanageUtil.getAa10toJsonArray("AJDJAJLY")%>;
	...
	function myprint() {
		...
		var v_sxfzysid = $("#sxfzysid").val();
		var url = "<%=basePath%>pub/wsgldy/zfwssxfzajyss5PrintIndex?ajdjid="+v_ajdjid+"&zfwsqtbid="+v_sxfzysid+"&time="+new Date().getMilliseconds();
	...
	<body class="b1 b2 zfwsbackgroundcolor">
	 <form id="myform" method="post">
		...
		<div id="head">	
			...
			<p>
			    <input class="easyui-validatebox bbtextarea" name="dsr" value="${mybean.dsr}"/>
