...
<% 
    ...
    if (request.getAttribute("mybean") != null) {
    	dto = (Zfwsajyss3DTO) request.getAttribute("mybean");
    }	
%>
<html>
<head>
...
.p4{text-indent:3.1930556in;margin-right:0.06944445in;margin-top:0.108333334in;
	text-align:end;hyphenate:auto;font-family:仿宋_GB2312;font-size:10.5pt;margin-left:5.5in;}
...
.p6{text-indent:-0.072916664in;margin-left:0.072916664in;text-align:justify;hyphenate:auto;
	font-family:仿宋_GB2312;font-size:10.5pt;}
.p7{text-indent:0.29166666in;margin-top:0.21666667in;text-align:justify;hyphenate:auto;
	font-family:仿宋_GB2312;font-size:10.5pt; line-height: 2em;}
.p8{text-indent:0.36458334in;margin-top:0.21666667in;text-align:justify;hyphenate:auto;
	font-family:仿宋_GB2312;font-size:10.5pt;}
.p9{margin-top:0.108333334in;text-align:justify;hyphenate:auto;font-family:仿宋_GB2312;
	font-size:10.5pt;margin-left:5.5in;}
.p10{text-indent:0.4375in;margin-top:0.108333334in;text-align:justify;hyphenate:auto;
	font-family:仿宋_GB2312;font-size:10.5pt;}
.p11{text-indent:3.7916667in;margin-top:0.108333334in;text-align:justify;hyphenate:auto;
	font-family:仿宋_GB2312;font-size:10.5pt;}
.p12{margin-right:0.65625in;margin-top:0.108333334in;text-align:end;hyphenate:auto;
	font-family:仿宋_GB2312;font-size:10.5pt;margin-left:5.5in;}
.p13{text-indent:1.3125in;margin-top:0.108333334in;text-align:justify;hyphenate:auto;
	font-family:仿宋_GB2312;font-size:10.5pt;}
.p14{text-indent:0.06944445in;margin-top:0.108333334in;text-align:justify;hyphenate:auto;
	font-family:仿宋_GB2312;font-size:10.5pt;}
</style>
...
function myprint(){
    ...
    var v_ajysid = $("#ajysid").val();
	var url = basePath + "pub/wsgldy/zfwsajyss3PrintIndex";
...
<body class=" b1  b2  zfwsbackgroundcolor" >
	<form id="myform" method="post">
		...
		<p class="p9">
		<span class="s1">				
		<input type="text" id="zfwsbh" name="zfwsbh" style="width: 260px;  " 
		value="${mybean.zfwsbh}"/>
		</span>
		</p>
		...
		<p class="p7"> 
		<span class="s3"> 		
		<input class="easyui-validatebox bbtextarea" id="ajysms" name="ajysms" 
		style="width: 400px;"value="${mybean.ajysms}"/>
		 （当事人姓名或名称+涉嫌构成的违法行为的概述）
		</span>
		
		<span class="s1">一案，经调查，</span>
		<span class="s3">		
		<input class="easyui-validatebox bbtextarea" id="ajysysyy" name="ajysysyy" 
		style="width: 400px;" value='${mybean.ajysysyy}'/>
