...
function CreatePrintPage() {
	...
	LODOP.ADD_PRINT_HTML("53mm","20mm","RightMargin:1.8cm","BottomMargin:2.2cm",strBodyStyle+document.getElementById("page1").innerHTML);
	//添加内容
...
<body class="b1 b2">
	...
	<div align="center" id="page1">
			...
			<%=StringHelper.myMakeStrLen(localZfwsajlydjbDTO.getAjdjay(),100,0) %></span>
			</p>
			<p class="p3 l24">
