...
<%@ page
	import="com.zzhdsoft.mvc.GlobalConfig,com.zzhdsoft.utils.SysmanageUtil,com.askj.zfba.dto.Zfwsxxdjbcwpcljds11DTO"%>
...
var v_ajdjajly = <%=SysmanageUtil.getAa10toJsonArray("AJDJAJLY")%>;
	...
	function myprint(){
			...
			var url="<%=basePath%>pub/wsgldy/ZfwsxxdjbcwpcljdsIndexPrint?ajdjid="
				+v_id+"&xxcljdsid="+v_xxcljdsid+"&time="+new Date().getMilliseconds();
		//创建模态窗口
	...
	<form id="myform" method="post">
		...
		<input id="xxcljdsid" name="xxcljdsid" type="hidden"
			...
			<p class="p5">
				...
				style="width: 175px;"
				<%if (dto.getXxcltzsnyr() != null) { %> 
				value="${mybean.xxcltzsnyr}"
