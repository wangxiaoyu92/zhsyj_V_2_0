    ...
    <form id="myform" method="post">
        ...
        <p class="p2">
			<span class="s2">案&nbsp;&nbsp;由：<input type="text" id="sxtzgzay" name="sxtzgzay"
                                                   style="width: 710px;text-align: left;"
                                                   value="${mybean.sxtzgzay}"/></span>
        </p>
        <p class="p3">
        ...
        <div align="right">
            <p class="p33">
                ...
                <span class="s3"><input type="text" id="cbrqz1" name="cbrqz1"
                                        style="width: 150px;"
                                        value="${mybean.cbrqz1}" <%=v_xzcfsxgzspb_cbrqz_readonly %>/></span>
                <span class="s3">、</span>
                <span class="s3"><input type="text" id="cbrqz2" name="cbrqz2"
                                        style="width: 150px;"
                                        value="${mybean.cbrqz2}" <%=v_xzcfsxgzspb_cbrqz_readonly %>/></span>
            </p>
            <p class="p33">
				<span class="s3">&times;年&times;月&times;日<input name="cbrqzrq" id="cbrqzrq"
                                                                ...
                                                                style="width: 200px;"
                                                                value="${mybean.cbrqzrq}" <%=v_xzcfsxgzspb_cbrqz_disable %>></span>
            </p>
        </div>
        <p class="p3">
        ...
        <div align="right">
            <p class="p33">
                ...
                <span class="s3"><input type="text" id="cbbmfzrqz" name="cbbmfzrqz"
                                        style="width: 150px;"
                                        value="${mybean.cbbmfzrqz}" <%=v_xzcfsxgzspb_cbbmfzrqz_readonly %>/></span>
            </p>
            <p class="p33">
				<span class="s3">&times;年&times;月&times;日<input name="cbbmfzrqzrq" id="cbbmfzrqzrq"
                                                                ...
                                                                onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"
                                                                style="width: 200px;"
                                                                value="${mybean.cbbmfzrqzrq}" <%=v_xzcfsxgzspb_cbbmfzrqz_disable%> ></span>
            </p>
        </div>
        <hr style="height:2px;border:none;border-top:2px solid #555555;"/>
        <p class="p3">
        ...
        <div align="right">
            <p class="p33">
                ...
                <span class="s3"><input type="text" id="fzjgfzrqz" name="fzjgfzrqz"
                                        style="width: 150px;"
                                        value="${mybean.fzjgfzrqz}" <%=v_xzcfsxgzspb_fzjgfzrqz_readonly %>/></span>
            </p>
            <p class="p33">
				<span class="s3">&times;年&times;月&times;日<input name="fzjgfzrqzrq" id="fzjgfzrqzrq"
                                                                ...
                                                                onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"
                                                                style="width: 200px;"
                                                                value="${mybean.fzjgfzrqzrq}" <%=v_xzcfsxgzspb_fzjgfzrqz_disable %> ></span>
            </p>
        </div>
        <hr style="height:2px;border:none;border-top:2px solid #555555;"/>
        <p class="p3">
        ...
        <div align="right">
            <p class="p33">
                ...
                <span class="s3"><input type="text" id="spbmfzrqz" name="spbmfzrqz"
                                        style="width: 150px;"
                                        value="${mybean.spbmfzrqz}" <%=v_xzcfsxgzspb_spfzrqz_readonly %>/></span>
            </p>
            <p class="p33">
				<span class="s3">&times;年&times;月&times;日<input name="spbmfzrqzrq" id="spbmfzrqzrq"
                                                                ...
                                                                onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"
                                                                style="width: 200px;"
                                                                value="${mybean.spbmfzrqzrq}" <%=v_xzcfsxgzspb_spfzrqz_disable %>></span>
            </p>
        </div>
        <hr style="height:2px;border:none;border-top:2px solid #555555;"/>
        <table>
