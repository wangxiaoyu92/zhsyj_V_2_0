...
<% 
    ...
    if (request.getAttribute("mybean") != null) {
    	dto = (ZfwsajlydjbDTO) request.getAttribute("mybean");
    }	
    String ajly=dto.getAjdjajly();
	boolean v_ajlydjb_ajlyfzrqz=SysmanageUtil.isExistsFuncByBizid("ajlydjb_ajlyfzrqz");
	String v_ajlydjb_ajlyfzrqz_readonly="";
	String v_ajlydjb_ajlyfzrqz_disable="";
	if (!v_ajlydjb_ajlyfzrqz){
		v_ajlydjb_ajlyfzrqz_readonly="readonly='readonly' class='zfwstextReadonly'";
		v_ajlydjb_ajlyfzrqz_disable="disabled='disabled'";		
	}   
...
.p3{margin-top:0.108333334in;text-align: right;hyphenate:auto;
	font-family:仿宋_GB2312;font-size:10pt;}
.p4{text-indent:0.06944445in;margin-top:0.108333334in;text-align:justify;
	hyphenate:auto;font-family:仿宋_GB2312;font-size:10.5pt;}
.p5{text-indent:-0.072916664in;margin-left:0.8020833in;margin-top:0.108333334in;
	text-align:justify;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p6{text-indent:0.072916664in;margin-top:0.108333334in;text-align:justify;
	hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p7{text-indent:0.072916664in;margin-top:0.108333334in;text-align:start;
	hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p8{text-indent:0.07013889in;margin-top:0.108333334in;text-align:start;
	hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p9{margin-left:0.07013889in;margin-top:0.108333334in;text-align:justify;
	hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p10{text-align:justify;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p11{text-indent:0.29166666in;margin-top:0.16666667in;text-align:justify;
	hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p12{text-indent:0.36458334in;margin-top:0.16666667in;text-align:justify;
	hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p13{text-align:center;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p14{text-indent:3.4270833in;margin-top:0.108333334in;text-align:justify;
	hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
...
function myprint(){
   // var v_zfwsqtbid=$("#zfwslydjid").val();
	...
	var url = basePath + "pub/wsgldy/zfwsajlydjbPrintIndex";
...
function tqMoban(){
    ...
    parent.sy.modalDialog({
		title:'模板提取',
         area: ['100%', '100%']
        , content: basePath + 'pub/wsgldy/zfwsmobantqIndex'
        , param: {
            zfwsdmmc : "<%=v_fjcsdmmc%>",
            zfwsdmz : v_zfwsdmz,
            time : new Date().getMilliseconds()
...
function setajly(){
	var v_ajly = $("input[name='ajdjajly2']:checked").val(); 
	$("#ajdjajly").val(v_ajly);
}
...
<div style="width: 210mm; margin: 0 auto">
    ...
    <form id="myform" method="post">
		...
		<p class="p3">
		<span class="s2"><input type="text" id="ajlywsbh" name="ajlywsbh" style="width: 260px;text-align: right;"  
		value="${mybean.ajlywsbh}"/></span>
		</p>
		<hr style="height:2px;border:none;border-top:2px solid #555555;" />
		<p class="p4">
		<span class="s2">
		    案件来源：<input type="radio" name="ajdjajly2" id="ajdjajly2" value="1" onchange="setajly()"
		    <% if (dto.getAjdjajly()!=null && dto.getAjdjajly().equals("1")) {%>checked="checked"<%}%>  >
		    	监督检查&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
		    <input type="radio" name="ajdjajly2" id="ajdjajly2" value="2" onchange="setajly()"
		    <% if (dto.getAjdjajly()!=null && dto.getAjdjajly().equals("2")) {%>checked="checked"<%}%>  >
		    投诉/举报&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		    <input type="radio" name="ajdjajly2" id="ajdjajly2" value="3" onchange="setajly()"
		    <% if (dto.getAjdjajly()!=null && dto.getAjdjajly().equals("3")) {%>checked="checked"<%}%>  >
		    上级交办&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		    <input type="radio" name="ajdjajly2" id="ajdjajly2" value="4" onchange="setajly()"
		    <% if (dto.getAjdjajly()!=null && dto.getAjdjajly().equals("4")) {%>checked="checked"<%}%>  >
		    下级报请&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
		</p>
		<p class="p5">
		<span class="s2">
		    <input type="radio" name="ajdjajly2" id="ajdjajly2" value="5" onchange="setajly()"
		    <% if (dto.getAjdjajly()!=null && dto.getAjdjajly().equals("5")) {%>checked="checked"<%}%>  >
		    监督抽验&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		    <input type="radio" name="ajdjajly2" id="ajdjajly2" value="6" onchange="setajly()"
		    <% if (dto.getAjdjajly()!=null && dto.getAjdjajly().equals("6")) {%>checked="checked"<%}%> >
		    移送&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		    <input type="radio" name="ajdjajly2" id="ajdjajly2" value="7" onchange="setajly()"
		    <% if (dto.getAjdjajly()!=null && dto.getAjdjajly().equals("7")) {%>checked="checked"<%}%> >其他
		</span>
	</p>
	<p class="p6">
	...
	<p class="p6">
	<span class="s2">法定代表人（负责人）/自然人:</span><span class="s3"><input id="ajlyfddbr" name="ajlyfddbr" 
	style="width: 260px;"  value="${mybean.ajlyfddbr}"/></span><span class="s2">联系电话:</span>
	<span class="s3"><input id="ajlylxdh" name="ajlylxdh" style="width: 260px;"  value="${mybean.ajlylxdh}"/></span>
	</p>
	<p class="p7">
	<span class="s2">法定代表人（负责人）/自然人身份证号码：</span><span class="s3">
	<input id="ajlyfddbrsfzh" name="ajlyfddbrsfzh" style="width: 500px;"  value="${mybean.ajlyfddbrsfzh}"/></span>
	</p>
	<p class="p8">
	...
	<p class="p3">
	<span class="s2">&times;年&times;月&times;日 <input name="ajlyjlrqzrq" id="ajlyjlrqzrq"  
	class="Wdate" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" readonly="readonly" 
	style="width: 175px;" value="${mybean.ajlyjlrqzrq}" ></span>
	</p>
	<p class="p13"></p>
	<hr style="height:2px;border:none;border-top:2px solid #555555;" />
	...
	<span class="s2">处理意见：</span>
	   ...
	   <textarea class="easyui-validatebox bbtextarea" <%=v_ajlydjb_ajlyfzrqz_readonly %>  
	   id="ajlyclyj" name="ajlyclyj" style="width: 800px;height: 200px;" 
	    data-options="required:false,validType:'length[0,500]'">${mybean.ajlyclyj}</textarea>
	<p class="p3">
	<span class="s2">负责人：<input id="ajlyfzr" name="ajlyfzr" style="width: 100px;"<%=v_ajlydjb_ajlyfzrqz_readonly %> 
	class="easyui-validatebox" data-options="validType:'length[0,20]'" value="${mybean.ajlyfzr}"/>(签字)   </span>
	</p>
	<p class="p3">
	<span class="s2">     &times;年&times;月&times;日<input name="ajlyfzrqzsj" id="ajlyfzrqzsj"  class="Wdate" 
	onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" readonly="readonly" 
	style="width: 175px;" <%=v_ajlydjb_ajlyfzrqz_disable %> value="${mybean.ajlyfzrqzsj}" > </span>
	</p>
	<p class="p15"></p>
	<hr style="height:2px;border:none;border-top:2px solid #555555;" />
