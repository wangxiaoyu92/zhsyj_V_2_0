    ...
    <form id="myform" method="post">
        ...
        <p class="p3">
				<span class="s2">当事人： <input id="cfspdsr" name="cfspdsr"
                                             style="width: 60px;" value="${mybean.cfspdsr}"/> </span>
        </p>
        <p class="p3">
        ...
        <p class="p3">
				<textarea id="cfspwfss" name="cfspwfss" style="width: 800px;height: 200px;"
                          data-options="required:false">${mybean.cfspwfss}</textarea>
        </p>
        <p class="p5"></p>
        <p class="p5"></p>
        <p class="p5"></p>
        ...
        <p class="p3">
            根据上述情况，拟对该单位（人）给予
            <textarea id="cfspcfjd" name="cfspcfjd" style="width: 800px;height: 100px;">${mybean.cfspcfjd}</textarea>
            的行政处罚决定。
        </p>
        <p class="p7"></p>
        <p class="p3">
        ...
        <p class="p8"></p>
        <p class="p4">
				<span class="s2"> 承办人1： <input id="cfspcbrqz" name="cfspcbrqz"
                                               style="width: 60px;" value="${mybean.cfspcbrqz}"/> （签字） </span><br>
            <span class="s2"> 承办人2： <input id="cfspcbrqz2" name="cfspcbrqz2"
        ...
        <p class="p4">
				<span class="s3"> 负责人： <input id="cfspshbmfzr" <%=v_xzcfjdspb_cfspshbmfzr_readonly %> name="cfspshbmfzr"
                                              style="width: 60px;" value="${mybean.cfspshbmfzr}"/> （签字） </span>
        </p>
        <p class="p4">
