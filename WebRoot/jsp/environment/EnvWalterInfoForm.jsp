...
<% 
	...
	String walterid = StringHelper.showNull2Empty(request.getParameter("walterid"));
%>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="easyui-layout" fit="true">                  
        <div region="center" style="overflow: scroll;" border="false">
        	<form id="fm" method="post" >
				...
				<input id="cppcpch" name="cppcpch"  type="hidden"/>
	        		<table class="table" style="width: 99%;">	  
	        		    <tr hidden="hidden">
							<td style="text-align:right;"><nobr>水ID：</nobr></td>
							<td><input id="walterid" name="walterid" style="width: 200px;" value="<%=walterid%>" /></td>
						</tr>
						<tr>
