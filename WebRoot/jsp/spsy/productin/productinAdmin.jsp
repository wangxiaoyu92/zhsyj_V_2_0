...
<%
	...
	String v_cphyclbz = StringHelper.showNull2Empty(request.getParameter("cphyclbz"));
%>
<!DOCTYPE html>
<html>
<head>
...
var mytab;
	...
	function addProductin(){
		var dialog =  parent.sy.modalDialog({
			...
			width : 950,
			height : 600,
			url : basePath + "spsy/productin/productinaddIndex?cphyclbz=<%=v_cphyclbz%>",
			buttons : [{
				text : '确定',
				handler : function() {
