...
<%
	...
	String operatetype = StringHelper.showNull2Empty(request.getParameter("operatetype"));  //选项
%>
<!DOCTYPE html>
<html>
<head>
...
//			intSelectData('ajjsbz', V_AJJSBZ);
			...
			table.render({
				...
				, cols: [[
					...
					, {field: 'nodename', width: 220, title: '节点名称', event: 'trclick'}
...
//						 		$("#grid").datagrid('reload');
//						 		parent.$.messager.progress('close');
						 		layer.alert('回退成功！','info',function(){
                                    window.location.href = window.location.href;
				        		});
			              	} else {
//			              		parent.$.messager.progress('close');
			              		layer.alert('回退失败：'+result.msg,'error');
                                window.location.href = window.location.href;
			                }
				        }
					});
