...
CKEDITOR.editorConfig = function (config) {
    ...
    [
        ...
        {name: 'document', items: ['Source', 'Print']}//源代码栏：查看源代码
    ];
    ...
    //JSP方式实现
	config.filebrowserBrowseUrl = basePath + 'jslib/ckeditor_4.7.0/uploader/browse.jsp';   
    config.filebrowserImageBrowseUrl = basePath + 'jslib/ckeditor_4.7.0/uploader/browse.jsp?type=Images';   
    config.filebrowserFlashBrowseUrl = basePath + 'jslib/ckeditor_4.7.0/uploader/browse.jsp?type=Flashs';   
    
    config.filebrowserUploadUrl = basePath + 'jslib/ckeditor_4.7.0/uploader/upload.jsp';   
    config.filebrowserImageUploadUrl = basePath + 'jslib/ckeditor_4.7.0/uploader/upload.jsp?type=Images';   
    config.filebrowserFlashUploadUrl = basePath + 'jslib/ckeditor_4.7.0/uploader/upload.jsp?type=Flashs';  
    config.filebrowserFlvUploadUrl = basePath + 'jslib/ckeditor_4.7.0/uploader/upload.jsp?type=Flvs'; 
