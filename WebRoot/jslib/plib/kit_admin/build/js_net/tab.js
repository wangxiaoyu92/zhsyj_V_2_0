...
layui.define(['jquery', 'element', 'nprogress', 'utils'], function(exports) {
    ...
    var Tab = function() {
        this.config = {
            elem: undefined,
            mainUrl: basePath + '/jsp/welcome_ty.jsp',
            renderType: 'iframe',
            openWait: false//wangyuqi  取消加载进度条
        };
        this.v = '1.0.5';
    };
    ...
    var _tab = {
        ...
        createTabDom: function() {
            ...
            var tpl = [
                    ...
                    '</ul>',
                    '<div class="kit-tab-tool"><i class="iconfont icon-caozuo"></i> 操作&nbsp;<i class="fa fa-caret-down"></i></div>',
                    ...
                    '<li class="kit-item" data-target="closeCurrent"><i class="fa fa-remove (alias)"></i> 关闭当前选项卡</li>',
                    '<li class="kit-item" data-target="closeOther"><i class="iconfont icon-prohibit"></i> 关闭其他选项卡</li>',
                    '<li class="kit-line"></li>',
                    '<li class="kit-item" data-target="closeAll"><i class="iconfont icon-guanbi"></i> 关闭所有选项卡</li>',
                    '</ul>',
                    '</div>',
        ...
        tabAdd: function(options) {
            ...
            var title = options.title,
                icon = options.icon,
                url = (options.url.indexOf("http:")>-1||options.url.indexOf("https:")>-1?"":basePath)+ options.url,
                id = options.id;
