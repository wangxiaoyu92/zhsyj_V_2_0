...
<body class="LoginBgStyle">
	<div align="center">
		<table width="1087" height="601" border="0" cellpadding="0"	cellspacing="0">
			<tr>
				<td height="601" class="LoginBgStyle_zfba">
					<div class="maintab02">
												...
												<tr>
													...
													<td width="351" nowrap="nowrap">
														<table width="351" border="0" cellspacing="0"	cellpadding="0">
														  ...
														  <tr align=center>
														  	<td>
														  	<a href="<%=basePath%>pub/pub/newComUserRegIndex" target="_self">企业在线注册</a>&nbsp;&nbsp;&nbsp;&nbsp;
															<a href="company_find_pwd.jsp" target="_self">忘记登录密码？</a>
														  	</td>
														  </tr>
														</table>
													</td>
