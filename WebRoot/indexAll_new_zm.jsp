...
<%-- gu20180610           <div class="col-md-2 col-sm-3 col-xs-4  work  "><a href="javascript:linkToSelf('index.jsp?systemcode=zsxt');" class="work-box">
            ...
            <div class="col-md-2 col-sm-3 col-xs-4  work  "><a href="javascript:linkToSelf('index_zhsyj_zm.jsp?systemcode=zsxt');" class="work-box">
                <img src="${ctx}/images/all/work-2.jpg" alt="">
                <div class="overlay">
                    <div class="overlay-caption">
                        <h4>食品安全追溯系统</h4>
