...
<script type="text/javascript">
	...
	$(function() {
		...
		$('td').click(function() {//绑定点击td事件，作用是点击td的时候，就可以选中，不一定非得点击radio组件
			...
			$.messager.alert('提示',$(':radio:checked').val(),'info');
		});
...
<body>
	<table class="table" style="width: 100%;">
		...
		<tr>
			...
			<td><input name="r" value="icon-excel" type="radio" /></td>
		...
		<tr>
			<td><input name="r" value="icon-modify" type="radio" /></td>
			<td><input name="r" value="icon-delete" type="radio" /></td>
			<td><input name="r" value="icon-upload" type="radio" /></td>
			<td><input name="r" value="icon-download" type="radio" /></td>
			...
			<td><input name="r" value="icon-unlock" type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="icon-key" type="radio" /></td>
			<td><input name="r" value="icon-group_key" type="radio" /></td>
			<td><input name="r" value="icon-home" type="radio" /></td>
