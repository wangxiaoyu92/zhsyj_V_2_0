...
<%@ page import="com.zzhdsoft.siweb.entity.sysmanager.Sysuser,com.askj.baseinfo.service.pub.PubService,com.askj.baseinfo.dto.DaibanshixiangDTO" %>
...
<script type="text/javascript" charset="utf-8">
	...
	function baoqingchuli(){	 
	    var obj = new Object();
	    var url = basePath+'pub/pub/baoqingchuliIndex?time='+new Date().getMilliseconds();
		var dialog = parent.sy.modalDialog({
			title : '待办事项',
			width : 1000,
			height : 560,
				...
				<td width="50%" valign="top" height="100%">
					<div id="p2" class="easyui-panel" title="通知公告"     
				        ...
				        data-options="iconCls:'ext-icon-bell',closable:false,    
				                collapsible:true,minimizable:false,maximizable:false">   
					    <p><font style='color:red;font-weight:bold' id="notice">食药监局综合监管信息平台上线测试，如有问题请联系系统管理员！</font></p>     
					</div> 													
				</td>						
			</tr>
			<tr align="center" >				
				<td width="50%" valign="top" height="100%">
					<div id="p3" class="easyui-panel" title="待办事项"     
				        ...
				        data-options="iconCls:'ext-icon-clock_red',closable:false,    
				                collapsible:true,minimizable:false,maximizable:false">   
					    <p>你有【<font style='color:red;font-weight:bold' id="sjqdrs"><input type="text" id="baoqingsx" name="baoqingsx" style="border: none;width: 20px;background:none;"></input></font>】项报请事项，请及时处理！<a href="javascript:baoqingchuli();">查看或处理</a></a></p>     
					</div> 	        
				</td>
				<td width="50%" valign="top" height="100%">
					<div id="p4" class="easyui-panel" title="证审提醒"     
				        ...
				        data-options="iconCls:'ext-icon-sound',closable:false,    
				                collapsible:true,minimizable:false,maximizable:false">   
					    <p>《许可证》即将到期<a onclick="loadSjzstxDetail('querySjjszdqtx')" style="cursor:hand;">【<font style='color:red;font-weight:bold' id="jsz">0</font>】</a>人，请及时处理！</p>     
					</div> 													
				</td>						
			</tr>
     	</table>	               	
