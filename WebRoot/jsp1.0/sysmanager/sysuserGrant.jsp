...
var settingaaa027 = {
	...
	function onCheckaaa027(event, treeId, treeNode) { 
		var treeObj = $.fn.zTree.getZTreeObj("treeDemo_aaa027usergrant");         
	...
	$(function() { 
		initAaa027UserGrantZTree();	
	}); 
	
	// 初始化权限树zTree
	function initAaa027UserGrantZTree(){
		$.ajax({
			...
			success: function(result) {
				if (result.code == '0') {
					...
					$.fn.zTree.init($("#treeDemo_aaa027usergrant"), settingaaa027, zNodes);
...
<body>
	<div class="easyui-layout" fit="true">
	        		...
	        		<table>
						<tr>
							...
							<td><a href="javascript:void(0)" class="easyui-linkbutton" data="btn_saveSysuserRole"
								iconCls="icon-group_key" plain="true" onclick="sysuserRole()">用户绑定角色</a>
							</td>
							<td>  
								<div class="datagrid-btn-separator"></div>
							</td> 
		...
		<div id="dlg2" class="easyui-dialog" style="width:900px;height:530px;overflow: hidden;"
			closed="true" closeable="true"  modal="true">
			<div id="tt" class="easyui-tabs" style="width:900px;height:530px;">
			    <div title="角色授权" style="padding:20px;" >
					<sicp3:groupbox title="角色授权">
					<table>
						<tr>
							<td>
								<table id="grid2"  style="width:420px;height:380px;overflow-y:auto;overflow-x:hidden;"></table>
							</td>
							<td style="text-align:center;">
								<table>
									<tr><td><a href="javascript:void(0);" class="easyui-linkbutton"  data-options="plain:true,iconCls:'ext-icon-control_fastforward_blue'" onclick="btn1('grid2');" >全右</a></td></tr>
									<tr><td><a href="javascript:void(0);" class="easyui-linkbutton"  data-options="plain:true,iconCls:'ext-icon-control_end_blue'" onclick="btn2('grid2');" >选右</a></td></tr>
									<tr><td><a href="javascript:void(0);" class="easyui-linkbutton"  data-options="plain:true,iconCls:'ext-icon-control_start_blue'" onclick="btn3('grid2');" >选左</a></td></tr>
									<tr><td><a href="javascript:void(0);" class="easyui-linkbutton"  data-options="plain:true,iconCls:'ext-icon-control_rewind_blue'" onclick="btn4('grid2');" >全左</a></td></tr>
								</table>
							</td>
							<td>
								<table id="grid3" style="width:420px;height:380px;overflow-y:auto;overflow-x:hidden;"></table>
							</td>
						</tr>
					</table>	
			    ...
			    <div title="四品一械大类授权" data-options="closable:false" style="overflow:auto;padding:20px;">
					<sicp3:groupbox title="四品一械大类授权">
					<table>
						<tr>
							<td>
								<table id="gridaae1"  style="width:420px;height:380px;overflow-y:auto;overflow-x:hidden;"></table>
							</td>
							<td style="text-align:center;">
								<table>
							...
							<td>
								<table id="gridaae2" style="width:420px;height:380px;overflow-y:auto;overflow-x:hidden;"></table>
							</td>
						</tr>
					</table>
			    ...
			    <div title="行政区划授权" data-options="iconCls:'icon-reload',closable:false" style="padding:20px;">
					<sicp3:groupbox title="行政区划授权">
		        		<div style="width:400px;height:340px;overflow: hidden;">
							<ul id="treeDemo_aaa027usergrant" class="ztree" ></ul>  
							<input type="hidden" id="aaa027treeCheckedNodes">
						</div>
										
					</sicp3:groupbox> 
					<div id="dlg2-buttons">
						<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" onclick="saveSysuserRole();">确定</a>
						<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" onclick="javascript:$('#dlg2').dialog('close')">取消</a>
					</div>
			    </div>
			    <div title="机构授权" data-options="iconCls:'icon-reload',closable:false" style="padding:20px;">
					<sicp3:groupbox title="机构授权">
					<table>
						<tr>
							<td>
								<table id="gridorg1"  style="width:420px;height:380px;overflow-y:auto;overflow-x:hidden;"></table>
							</td>
							<td style="text-align:center;">
								<table>
									<tr><td><a href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'ext-icon-control_fastforward_blue'" onclick="btn1();" ></a></td></tr>
									<tr><td><a href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'ext-icon-control_end_blue'" onclick="btn2();" ></a></td></tr>
									<tr><td><a href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'ext-icon-control_start_blue'" onclick="btn3();" ></a></td></tr>
									<tr><td><a href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'ext-icon-control_rewind_blue'" onclick="btn4();" ></a></td></tr>
								</table>
							</td>
							<td>
								<table id="gridorg2" style="width:420px;height:380px;overflow-y:auto;overflow-x:hidden;"></table>
							</td>
						</tr>
					</table>	
					</sicp3:groupbox> 
