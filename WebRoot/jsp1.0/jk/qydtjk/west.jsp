...
<script type="text/javascript">
	...
	var showJk = function(aaa027,comdalei_v,comhhbbz,comspjkbz,combxbz,commc) {
		...
		var url = encodeURI("/jk/jkgl/qydtjkmonitorIndex?aaa027="+aaa027+"&comdalei="+comdalei_v+"&comhhbbz="+comhhbbz+"&comspjkbz="+comspjkbz+"&combxbz="+combxbz+"&commc="+commc);
