...
//zjf add
XiorkFlowWorkSpace.realPath = localhostPath + projectName;
...
//
XiorkFlowWorkSpace.BASE_PATH = projectName + "/";
//alert(XiorkFlowWorkSpace.BASE_PATH);
//alert( XiorkFlowWorkSpace.BASE_PATH)
//
XiorkFlowWorkSpace.XIORK_FLOW_PATH = XiorkFlowWorkSpace.BASE_PATH + "jsp/XiorkFlow/";
//alert(XiorkFlowWorkSpace.XIORK_FLOW_PATH)
//
...
XiorkFlowWorkSpace.URL_ADD_PROCESS = XiorkFlowWorkSpace.realPath + "/workflow/addWfprocess";
XiorkFlowWorkSpace.URL_DELETE_PROCESS = XiorkFlowWorkSpace.realPath + "/workflow/delWfprocess";
XiorkFlowWorkSpace.URL_UPDATE_PROCESS = XiorkFlowWorkSpace.realPath + "/workflow/updateWfprocess";
XiorkFlowWorkSpace.URL_GET_PROCESS = XiorkFlowWorkSpace.realPath + "/workflow/getWfprocess";
XiorkFlowWorkSpace.URL_LIST_PROCESS = XiorkFlowWorkSpace.realPath + "/workflow/wf_listprocess";
...
XiorkFlowWorkSpace.build = function () {
	...
	//name.xio.util
    alert(XiorkFlowWorkSpace.XIORK_FLOW_PATH + "src/name/xio/util/Message.js");
