	        		...
	        		<table class="table" style="width: 99%;">	        		    
						...
						<tr>		
						 ...
						 <tr>
							...
							<td><input id="newstitle" name="newstitle" style="width: 260px;" class="easyui-validatebox" data-options="required:true" value="<%=newstitle %>"/></td>						
						</tr>
						<tr>		
							<td style="text-align:right;"><nobr>预案内容：</nobr></td>
							<td colspan="3">
								<div height="60px" style="overflow: auto;">
						        	<textarea class="ckeditor" id="newscontent" name="newscontent" cols="20" rows="50"><%=newscontent %></textarea>
								</div>
							</td>
						</tr>
					</table>
