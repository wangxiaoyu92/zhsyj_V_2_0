...
<div class="page_wrap_two">
	<div class="page_left_two">
		<div id="zwgg">
	        <h2 class="news_h2"><span class="news_more"><a href="javascript:linkToSelf('<%=contextPath %>/jsp/asfoodsafe/news_list.jsp?currlocation=国内动态&catejc=gndt');">更多>></a></span><span class="news_title_span">国内动态</span></h2>
			<ul class="news_ul">
			<%				
			...
			%>
					<li><a href="javascript:linkToSelf('<%=contextPath %>/jsp/asfoodsafe/news_detail.jsp?newsid=<%=bean.getNewsid() %>');" title="<%=bean.getNewstitle()%>"><%=PubFunc.abbreviate(bean.getNewstitle(),2*18,"...")%></a><span><%=PubFunc.split(bean.getNewstjsj().toString()," ")[0]%></span></li>
			<%
					}
				}
			%>
	...
	<div class="page_center_two">
	 	<div id="zwgg">
	    	<h2 class="news_h2"><span class="news_more"><a href="javascript:linkToSelf('<%=contextPath %>/jsp/asfoodsafe/news_list.jsp?currlocation=国际动态&catejc=gjdt');">更多>></a></span><span class="news_title_span">国际动态</span></h2>
			<ul class="news_ul">
			<%				
	...
	<div class="page_right_two">
		<ul class="images_ul2">
	 	...
	 	<li><a href="javascript:linkToSelf('<%=contextPath %>/jsp/asfoodsafe/news_detail.jsp?newsid=2017062317020172925970950');"><img src="<%=contextPath %>/jsp/asfoodsafe/images/mzsm.jpg" style="margin-bottom:3px"></a></li>
	 	<li><img src="images/kfdh2.jpg"></li>
	 	</ul>
	</div>
</div>
...
<div class="page_wrap_two">
	<div class="page_left_two">
		<div id="zwgg">
	        <h2 class="news_h2"><span class="news_more"><a href="javascript:linkToSelf('<%=contextPath %>/jsp/asfoodsafe/com_list.jsp?currlocation=追溯企业');">更多>></a></span><span class="news_title_span">溯源企业</span></h2>
			...
			%>
			<li><a href="javascript:linkToSelf('<%=contextPath %>/jsp/asfoodsafe/com_detail.jsp?comid=<%=comid %>&commc=<%=commc%>');" title="<%=commc%>"><%=commc2%></a><span>2017-10-10</span></li>
			<%
					}
				}
			%>
	...
	<div class="page_center_two">
	 	<div id="zwgg">
	    	<h2 class="news_h2"><span class="news_more"><a href="javascript:linkToSelf('<%=contextPath %>/jsp/asfoodsafe/news_list.jsp?currlocation=政策法规&catejc=gjzc');">更多>></a></span><span class="news_title_span">政策法规</span></h2>
			<ul class="news_ul">
			<%
	...
	<div class="page_right_two">
		<ul class="images_ul">
		<li><a href="javascript:linkToSelf('<%=contextPath %>/jsp/asfoodsafe/news_detail.jsp?newsid=2017062317020149685258464');"><img src="images/gypt.jpg"></a></li>
		<li><a href="lxwm.jsp" target="_blank"><img src="<%=contextPath %>/jsp/asfoodsafe/images/lxwm.jpg"></a></li>
		</ul>
	</div>
</div>
