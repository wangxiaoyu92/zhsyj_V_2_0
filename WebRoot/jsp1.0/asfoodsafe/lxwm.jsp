...
<script type="text/javascript" src="http://api.map.baidu.com/getscript?v=1.1&ak=&services=true&t=20121127154638"></script>
</head>
<body>
<div id="full">
	<div class="w_top">
...
<!--百度地图容器-->
<div>
<div id=dituContent style="margin:0 auto;border:#ccc 1px solid;width:1000px;height:350px;text-align:center;"></div>
<script type=text/javascript> 
    ...
    function createMap(){ 
        ...
        var point = new BMap.Point(113.606102,34.800042);//定义一个中心点坐标如天安门 12963679.03, 4822467.83 
    ...
    //标注点数组 
    var markerArr = [{title:"安盛食品安全追溯平台服务中心",content:"电话：400-888-6785<br/>传真：0371-65997333<br/>地址：郑州高新区河南省国家大学科技园东区12号楼18层 <br/>",point:"113.606102|34.800042",isOpen:1,icon:{w:23,h:25,l:23,t:21,x:9,lb:12}} 
         ]; 
    //创建marker 
    function addMarker(){ 
    ...
    function createIcon(json){ 
        var icon = new BMap.Icon("http://dev.baidu.com/map/images/us_mk_icon.png", new BMap.Size(json.w,json.h),{imageOffset: new BMap.Size(-json.l,-json.t),infoWindowOffset:new BMap.Size(json.lb+5,1),offset:new BMap.Size(json.x,json.h)}) 
        return icon; 
    } 
    initMap();//创建和初始化地图 
</script>
