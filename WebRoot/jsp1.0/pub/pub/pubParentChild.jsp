        ...
        <sicp3:groupbox title="分类信息">
            <form id="fm" name="fm" method="post">
                <table class="table" style="width: 80%;">
                    <tr>
                        <td style="text-align:right;"><nobr>通用父子关系表ID:</nobr></td>
                    ...
                    <tr>
                        <td style="text-align:right;"><nobr>属性1:</nobr></td>
                        <td><input id="sx1" name="sx1" style="width: 200px;" /></td>
                    </tr>
                    <tr>
                        <td style="text-align:right;"><nobr>属性2:</nobr></td>
                        <td><input id="sx2" name="sx2" style="width: 200px;" /></td>
                    </tr>
                    <tr>
                        <td style="text-align:right;"><nobr>属性3:</nobr></td>
                        <td><input id="sx3" name="sx3" style="width: 200px;" /></td>
                    </tr>
                    <tr>
                        <td style="text-align:right;"><nobr>属性4:</nobr></td>
                        <td><input id="sx4" name="sx4" style="width: 200px;" /></td>
                    </tr>
                    <tr>
                        <td style="text-align:right;"><nobr>属性5:</nobr></td>
                        <td><input id="sx5" name="sx5" style="width: 200px;" /></td>
                    </tr>
                    <tr>
                        <td style="text-align:right;"><nobr>属性6:</nobr></td>
                        <td><input id="sx6" name="sx6" style="width: 200px;" /></td>
                    </tr>
                    <tr>
                        <td style="text-align:right;"><nobr>属性7:</nobr></td>
                        <td><input id="sx7" name="sx7" style="width: 200px;" /></td>
                    </tr>
                    <tr>
                        <td style="text-align:right;"><nobr>属性8:</nobr></td>
                        <td><input id="sx8" name="sx8" style="width: 200px;" /></td>
                    </tr>
                    <tr>
                        <td style="text-align:right;"><nobr>属性9:</nobr></td>
                        <td><input id="sx9" name="sx9" style="width: 200px;" /></td>
                    </tr>
                    <tr>
                        <td style="text-align:right;"><nobr>属性10:</nobr></td>
                        <td><input id="sx10" name="sx10" style="width: 200px;" /></td>
                    </tr>
                </table>
            </form>
            <br/>
