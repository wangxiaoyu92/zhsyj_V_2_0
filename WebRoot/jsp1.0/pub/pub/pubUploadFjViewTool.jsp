...
<body style="margin:0 auto;padding:0;text-align:center;">
   <div id="imageView_container" style="margin:0 auto;width:800px;height:600px;overflow:auto; border:1px solid #000000;padding:10px;text-align:center;">
   	<img id="Imgbox" src="<%=img_src %>" rel="<%=img_src %>" style="width:100%;height:100%;position:relative; zoom:100%;cursor:move;"/>
   </div>
   <br />
   <div>
	<a href="javascript:void(0);" class="easyui-linkbutton" onclick="imgToSize(80);">放大+</a>
	<a href="javascript:void(0);" class="easyui-linkbutton" onclick="imgToSize(-80);">缩小-</a>
	<a href="javascript:void(0);" class="easyui-linkbutton" onclick="$('#Imgbox').rotateLeft(90);">向左旋转</a>
	<a href="javascript:void(0);" class="easyui-linkbutton" onclick="$('#Imgbox').rotateRight(90);">向右旋转</a>
	<a href="javascript:void(0);" class="easyui-linkbutton" onclick="defaultSize();">合适尺寸80%</a>
	<a href="javascript:void(0);" class="easyui-linkbutton" onclick="fullSize();">原始尺寸</a>
	<a href="javascript:void(0);" class="easyui-linkbutton" onclick="window.close();">关闭返回</a>	 
   </div>
 <!-- 
