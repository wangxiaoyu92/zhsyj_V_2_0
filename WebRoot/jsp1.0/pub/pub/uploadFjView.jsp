		...
		<table style="width: 99%;">
	        <tr>
				<td style="text-align:center;">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-undo"  onclick="closeAndRefreshWindow();" id="btnCancel" >关闭</a>
				</td>
	        </tr>
		</table>
	</sicp3:groupbox>
<%-- 	<sicp3:groupbox title="上传图片预览">
	...
	<div id="picbox" style="width:100%;text-align:center;">	
	   <iframe name="myfrmname" id="myfrmid" scrolling="auto" frameborder="0" style="width:100%;height: 400px;" src="<%=v_iframeUrl%>"></iframe>
	</div>
</form>
</body>
</html>