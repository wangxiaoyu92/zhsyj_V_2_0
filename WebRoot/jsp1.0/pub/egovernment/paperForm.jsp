...
function tijiaoliucheng(){
	...
	var v_url="<%=basePath%>/egovernment/archive/gdArchive?archiveid=<%=v_ajdjid%>"
	var v_url2=encodeURI(encodeURI("<%=basePath%>workflow/doWfprocess?ywlcid=<%=v_ywlcid%>&transval="+v_transval+"&shifouTongguo="+v_shifouTongguo+"&transname="+v_transname+"&transyy="+v_transyy+"&time="+new Date().getMilliseconds()));
