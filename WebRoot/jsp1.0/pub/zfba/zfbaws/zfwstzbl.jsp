...
<% 
    ...
    if (request.getAttribute("mybean") != null) {
    	localZfwstzbl24DTO = (Zfwstzbl24DTO) request.getAttribute("mybean");
    }	
%>
<html>
<head>
...
<div style="width: 210mm; margin: 0 auto">
    ...
    <form id="myform" method="post">
		...
		<p class="p4">
			...
			class="zfwsInputtextReadonly" readonly="readonly" 
			style="width: 720px;text-align: left;" value="${mybean.commc}"/></span>
		</p>
		<p class="p4">
			<span class="s2">法定代表人（负责人）：</span>
			<span class="s3"><input type="text" id="comfrhyz" name="comfrhyz" 
			class="zfwsInputtextReadonly" readonly="readonly" 
			style="width: 150px;text-align: left;" value="${mybean.comfrhyz}"/></span>
			<span class="s2">性别：</span>
			<span class="s3"><input type="text" id="tzblfddbrxbstr" name="tzblfddbrxbstr" 
			class="zfwsInputtextReadonly" readonly="readonly" 
			style="width: 60px;text-align: left;" value="${mybean.tzblfddbrxbstr}"/></span>
		...
		<p class="p4">
			...
			<span class="s3"><input name="tzbltzkssj" id="tzbltzkssj" placeholder="听证开始时间" 
			class="easyui-validatebox" data-options="required:true"
			onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" 
			style="width: 335px;" value="${mybean.tzbltzkssj}" ></span>
			<span class="s2">至</span>
			<span class="s3"><input name="tzbltzjssj" id="tzbltzjssj" placeholder="听证结束时间" 
			class="easyui-validatebox" data-options="required:true"
		...
		<textarea class="easyui-validatebox bbtextarea" id="tzbljl" 
			name="tzbljl" style="width: 770px;height: 200px;" 
    		data-options="required:true">${mybean.tzbljl}</textarea>
		<p class="p6">
			<span class="s2">当事人或委托代理人：<input id="tzbldsrqz" name="tzbldsrqz" 
				style="width: 150px" value="${mybean.tzbldsrqz}"/>（签字）
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                                                                                                            
			<input name="tzbldsrqzrq" id="tzbldsrqzrq" placeholder="当事人签字日期" 
		...
		<p class="p6">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                                                                                                            
			<input name="tzblajcbrrq" id="tzblajcbrrq" placeholder="承办人签字日期" 
			class="Wdate" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"  
		...
		<p class="p6">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                                                                             
			<input name="tzbltzzcrqzrq" id="tzbltzzcrqzrq" placeholder="听证主持人签字日期" 
			class="Wdate" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})"  
