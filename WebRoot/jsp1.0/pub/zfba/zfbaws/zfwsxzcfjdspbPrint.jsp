...
<div style="width: 210mm; margin: 0 auto;display: none;">
	<body class="b1 b2">
		...
		<div align="center" id="page<%=page_number%>">
			...
			<p class="p3">
				<span>案 由： <%=StringHelper.myMakeStrLen(localZfwsxzcfjdspb27DTO.getAjdjay(),0,0)%>
				</span>
			</p>
			<p class="p3">
				<span>当事人： <%=StringHelper.myMakeStrLen(localZfwsxzcfjdspb27DTO.getCommc(),0,0)%>
				</span>
			</p>
			<p class="p3">
			...
			<p class="p8"></p>
			<p class="p4">
				<span class="s2"> 承办人： <%=localZfwsxzcfjdspb27DTO.getCfspcbrqz()%>
					（签字） </span>
			</p>
			<p class="p4">
				<span class="s2"> <%=localZfwsxzcfjdspb27DTO.getCfspcbrqzrq().substring(0,4)%>
			...
			<p class="p7"></p>
			<p class="p4">
				<span class="s2"> 承办部门负责人： <%=localZfwsxzcfjdspb27DTO.getCfspcbbmfzr()%>
					（签字） </span>
			</p>
			<p class="p4">
				<span class="s2"> <%=localZfwsxzcfjdspb27DTO.getCfspcbfzrqz().substring(0,4)%>
					年<%=localZfwsxzcfjdspb27DTO.getCfspcbfzrqz().substring(5,7)%>
					月<%=localZfwsxzcfjdspb27DTO.getCfspcbfzrqz().substring(8,10)%>日
				</span>
			</p>
			<hr style="height:2px;border:none;border-top:2px solid #555555;" />
			...
			<p class="p4">
				<span class="s3"> 负责人： <%=localZfwsxzcfjdspb27DTO.getCfspshbmfzr()%>
					（签字） </span>
			</p>
			<p class="p4">
				<span class="s3"> <%=localZfwsxzcfjdspb27DTO.getCfspshbmfzrrq().substring(0,4)%>
			...
			<p class="p4">
				<span class="s3"> 负责人 <%=localZfwsxzcfjdspb27DTO.getCfspspyjfzr()%>
					（签字） </span>
			</p>
			<p class="p4">
				<span class="s3"> <%=localZfwsxzcfjdspb27DTO.getCfspspyjfzrrq().substring(0,4)%>
