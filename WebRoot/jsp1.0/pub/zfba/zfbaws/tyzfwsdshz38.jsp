...
<%@ page
	import="com.zzhdsoft.mvc.GlobalConfig,com.zzhdsoft.utils.SysmanageUtil,com.askj.zfba.dto.Zfwsdshz38DTO"%>
...
var v_ajdjajly = <%=SysmanageUtil.getAa10toJsonArray("AJDJAJLY")%>;
	...
	function myprint() {
		...
		var v_sdhzid = $("#sdhzid").val();
		var url = "<%=basePath%>pub/wsgldy/Zfwsdshz38IndexPrint?ajdjid="+v_zfwslydjid+"&zfwsqtbid="+v_sdhzid+"&time="+new Date().getMilliseconds();
		//创建模态窗口
	...
	<form id="myform" method="post">
		...
		<input id="sdhzid" name="sdhzid" type="hidden"
			...
			<p class="p1">
				...
				style="width:500px;" class="easyui-validatebox bbtextarea" data-options="required:false" value="${mybean.sdhzwsmcbh}" /></span>
				</p>
				<p class="p5"></p>
				<div id="fz">
					<p class="p3">
					...
					style="width:100px;" class="easyui-validatebox bbtextarea" data-options="required:false" value="${mybean.sdhzsdr}" /></p>
					<p class="p3">
						<span class="s3">受送达单位（人）：<input id="sdhzssddwqz" name="sdhzssddwqz" 
						style="width:100px;" class="easyui-validatebox bbtextarea" data-options="required:false" value="${mybean.sdhzssddwqz}" /></p>
				</div>
				<div id="fy">
					<p class="p3"> 
						<span class="fr">送达地点：<input id="sdhzsddd" name="sdhzsddd" 
						style="width:100px;" class="easyui-validatebox bbtextarea" data-options="required:false" value="${mybean.sdhzsddd}" /></span>
					</p>
					...
					<p class="p5" >
				      <span>&times;年&times;月&times;日
				       <input name="sdhzgzrq" id="sdhzgzrq"
						class="Wdate easyui-validatebox bbtextarea"
						data-options="required:false"
						onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm'})"
				...
				<p class="p5"></p> 
				<p class="p5"> 
				<span class="s3">备注：<textarea class="easyui-validatebox bbtextarea" id="sdhzbz" name="sdhzbz" style="width: 730px;height: 200px;" 
    				data-options="required:false">${mybean.sdhzbz}</textarea></span>
				</p>
				<p class="p5"></p>
				<p class="p5"></p>
				<p class="p5"></p>
