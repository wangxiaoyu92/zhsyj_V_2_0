...
<body class="b1 b2 zfwsbackgroundcolor">
	<form id="myform" method="post">
		...
		<input id="sdhzid" name="sdhzid" type="hidden" value="${mybean.sdhzid}" />
			<p class="p1">
			...
			<p class="p3">
				<span class="s3">送达文书名称及文书编号：(可为多个文书)</span>
				<textarea class="easyui-validatebox bbtextarea" 
				id="sdhzwsmcbh" name=sdhzwsmcbh style="width: 730px;height: 200px;">${mybean.sdhzwsmcbh}</textarea>
			</p>
			<p class="p5"></p>
			<div id="fz">
				<p class="p3">
			...
			<p class="p5"> 
				...
				<textarea class="easyui-validatebox bbtextarea" 
				id="sdhzbz" name="sdhzbz" style="width: 730px;height: 200px;">${mybean.sdhzbz}</textarea>
			</p>
			<hr style="height:2px;border:none;border-top:2px solid #555555;">
		<div id="btn">
			<table>
