...
<body class="b1 b2 zfwsbackgroundcolor">
	<form id="myform" method="post">
		...
		<div align="right">
			...
			<input type="text" id="xxclwsbh" name="xxclwsbh"style="width: 260px;"value="${mybean.xxclwsbh}"/>
			</span>
			</p>
		</div>
		...
		<div align="right">
			...
			<p class="p7">
			   <span class="s2">当事人签字：<input  name="xxcldsrqz" id="xxcldsrqz" value="${mybean.xxcldsrqz}" /></span>
			   <span>&times;年&times;月&times;日 <input name="xxcldsrqzrq" id="xxcldsrqzrq"  class="Wdate" 
					onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" 
