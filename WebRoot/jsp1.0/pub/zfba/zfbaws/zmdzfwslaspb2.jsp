		...
		<form id="myform" method="post">
			...
			<p class="p8">
				<span class="s2">经初步审查，当事人的行为涉嫌违反了
				 <input id="laspflfg" name="laspflfg" style="width: 450px;"  value="${mybean.laspflfg}" /><input type="button" style="color:blue;" value="选择" onclick="myselectPcyzdsz();">（法律法规名称及其条、款、项）
					的规定，申请予以立案。</span>
			</p>
			<p class="p10">
