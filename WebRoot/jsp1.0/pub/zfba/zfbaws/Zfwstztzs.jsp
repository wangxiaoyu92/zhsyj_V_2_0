...
function myprint(){
	...
	var url="<%=basePath%>pub/wsgldy/zfwstztzsPrintIndex?ajdjid="+v_ajdjid+"&time="+new Date().getMilliseconds();
...
<div style="width: 210mm; margin: 0 auto">
	<body class="b1 b2 zfwsbackgroundcolor">
		<form id="myform" method="post">
			...
			<input id="tztzsid" name="tztzsid" type="hidden"
				value="${mybean.tztzsid}" />
			...
			<p class="p3">
				<span class="s2"> </span> <span class="s3"> （
					）食药监&times;听通〔年份〕
					 <input id="tztzwsbh" name="tztzwsbh"  style="width: 150px;"
					  value="${mybean.tztzwsbh}" />号</span>
			</p>
			<p class="p4">
				<span class="s2"> <input id="commc" name="commc"
					style="width: 100px;" class="zfwsInputtextReadonly"
			...
			<p class="p8">
				<span class="s2">地 址： <input id="comdz" name="comdz"
					style="width: 260px;" class="zfwsInputtextReadonly"
					readonly="readonly" value="${mybean.comdz}" /> </span>
			</p>
			<p class="p8">
				<span class="s2">邮政编码： <input id="comyzbm" name="comyzbm"
					style="width: 260px;" class="zfwsInputtextReadonly"
					readonly="readonly" value="${mybean.comyzbm}" /> </span>
			</p>
			<p class="p8">
				<span class="s2">联系电话： <input id="comyddh" name="comyddh"
					style="width: 260px;" class="zfwsInputtextReadonly"
					readonly="readonly" value="${mybean.comyddh}" />
				</span>
			</p>
			<p class="p9">
				<span class="s2"> 联 系 人： <input id="comfrhyz" name="comfrhyz"
					style="width: 260px;" class="zfwsInputtextReadonly"
					readonly="readonly" value="${mybean.comfrhyz}" /> </span>
			</p>
			<p class="p10"></p>
			<p class="p11"></p>
			<p class="p11"></p>
