...
<div style="width: 210mm; margin: 0 auto;display: none">
	   <body class="b1 b2">
		...
		<div class="Noprint">
			...
			<p class="p3">
				<span class="s2">案 由：</span><span style="border-bottom: 1px solid  black;width: 560px;display: inline-block;">
					<%=localZfwslaspb2DTO.getAjdjay()%> </span>
			</p>
			<p class="p3">
				<span class="s2">当事人：</span><span style="border-bottom: 1px solid  black;width: 200px;display: inline-block;"><%=localZfwslaspb2DTO.getLaspdsr()%>
				 </span> 法定代表人（负责人）：
				 <span style="border-bottom: 1px solid  black;width: 190px;display: inline-block;">
				 <%=localZfwslaspb2DTO.getLaspfddbr()%>
				 </span>
			</p>
			<p class="p4">
				<span class="s2">地 址：</span>
				<span style="border-bottom: 1px solid  black;width: 205px;display: inline-block;"><%=localZfwslaspb2DTO.getLaspdz()%> </span>
				<span class="s2">联系方式：</span>
				<span style="border-bottom: 1px solid  black;width: 270px;display: inline-block;">  <%=localZfwslaspb2DTO.getLasplxfs()%> </span>
			</p>
			<p class="p4">
			...
			<p class="p10" style="margin-right:50px">
				<span class="s2"> 经办人：</span>
				 <span style="border-bottom: 1px solid  black;width: 90px;text-align:left; display: inline-block;">
			...
			<p class="p8">
				<span class="s2">建议本案由 
					  &nbsp;&nbsp;&nbsp;&nbsp; <%=localZfwslaspb2DTO.getLaspjyzb()%>   &nbsp;&nbsp;&nbsp;&nbsp; 承办。</span>
				<span class="s2">由  &nbsp;&nbsp;&nbsp;&nbsp; <%=localZfwslaspb2DTO.getLaspjyxb()%>   &nbsp;&nbsp;&nbsp;&nbsp;  协办。</span><br>
			</p> 
			</p>
			<p class="p10" style="margin-right:50px">
				<span class="s2"> 承办部门负责人： </span>
					 <span style="border-bottom: 1px solid  black;text-align:left;  width: 90px;display: inline-block;">
					<%=localZfwslaspb2DTO.getLaspcbbmfzr()%> </span>
			...
			<p class="p10" style="margin-right:50px">
				<span class="s2"> 分管负责人： </span>
				 <span style="border-bottom: 1px solid  black;text-align:left; width: 90px;display: inline-block;">
					<%=localZfwslaspb2DTO.getLaspfgfzr()%> </span> 
