...
<div style="width: 210mm; margin: 0 auto;display: none">
	   <body class="b1 b2">
		<div class="Noprint">
			...
			<p class="p3">
				<span class="s2"> </span> <span class="s3"> （）食药监x听通〔年份〕
					<%=localZfwstztzs23DTO.getTztzwsbh()%>
			</p>
			<p class="p4">
				<span class="s2"> <%=localZfwstztzs23DTO.getCommc()%>
				：</span>
			</p>
			<p class="p5">
				...
				<%=localZfwstztzs23DTO.getTztzsqrq().substring(0,4)%>
					...
					向本局提出听证申请，根据《中华人民共和国行政处罚法》第四十二条规定，本局决定于
					...
					在 <%=localZfwstztzs23DTO.getTztzdd() %>
			...
			<p class="p6">
				<span class="s2">本案听证主持人：<%=localZfwstztzs23DTO.getTztzzcr() %>
					 记录员： <%=localZfwstztzs23DTO.getTztzjly() %> 
			</p>
			<p class="p7">
				<span class="s2">根据《中华人民共和国行政处罚法》第四十二条的规定，你如申请主持人回避，可在听证举行前向本局提出回避申请并说明理由。</span>
			</p>
			<p class="p8">
				<span class="s2">地 址：<%=localZfwstztzs23DTO.getComdz()%>  </span>
			</p>
			<p class="p8">
				<span class="s2">邮政编码：<%=localZfwstztzs23DTO.getComyzbm()%>
				 </span>
			</p>
			<p class="p8">
				<span class="s2">联系电话：<%=localZfwstztzs23DTO.getComyddh()%>
				</span>
			</p>
			<p class="p9">
				<span class="s2">联 系 人：<%=localZfwstztzs23DTO.getComfrhyz()%> 
					  </span>
			</p>
			<p class="p10"></p>
			<p class="p11"></p>
