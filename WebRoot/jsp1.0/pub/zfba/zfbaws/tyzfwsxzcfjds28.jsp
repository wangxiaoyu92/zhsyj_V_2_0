...
.p4{text-indent:-0.072916664in;margin-left:0.09791667in;text-align:start;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p5{text-indent:0.29166666in;margin-right:0.013194445in;text-align:start;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p6{text-indent:-0.055555556in;margin-left:0.054166667in;text-align:justify;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p7{text-indent:-0.055555556in;text-align:start;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p8{text-indent:0.28611112in;margin-left:-0.054166667in;text-align:start;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p9{text-indent:0.28611112in;margin-left:-0.007638889in;text-align:start;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p10{text-align:start;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p11{text-indent:0.28611112in;text-align:justify;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p12{text-indent:0.28055555in;margin-left:0.072916664in;text-align:start;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p13{text-indent:0.28611112in;margin-left:0.0027777778in;text-align:start;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p14{margin-left:0.10763889in;text-align:justify;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p15{text-indent:0.28611112in;margin-left:0.072916664in;text-align:start;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p16{margin-right:0.29166666in;margin-top:0.108333334in;text-align:end;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p17{margin-top:0.108333334in;text-align:end;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p18{text-indent:0.3263889in;margin-left:0.072916664in;text-align:start;hyphenate:auto;font-family:宋体;font-size:12pt;}
.p19{text-align:start;hyphenate:auto;font-family:宋体;font-size:12pt;}
.p20{text-indent:0.06944445in;margin-top:0.108333334in;text-align:start;hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;}
.p21{text-align:justify;hyphenate:auto;font-family:Times New Roman;font-size:10pt;}
</style>
<title>行政处罚决定书</title>
    ...
    <form id="myform" method="post">
		...
		<p class="p4">
         <span>被处罚人（自然人）姓名：</span><span class="s3"><input type="text"
          id="cfjdbcfrzrrxm" name="cfjdbcfrzrrxm" style="width: 120px;text-align: left;"value="${mybean.cfjdbcfrzrrxm}"/></span>
         <span>性别：</span><span class="s3"><input type="text" id="cfjdbcfrzrrxb"
          name="cfjdbcfrzrrxb" style="width:100px;text-align: left;"value="${mybean.cfjdbcfrzrrxb}"/></span>
         <span>年龄：</span><span class="s3"><input type="text" id="cfjdbcfrzrrnl"
          name="cfjdbcfrzrrnl" style="width: 60px;text-align: left;"value="${mybean.cfjdbcfrzrrnl}"/></span>
        </p>
        <p class="p5">
         <span>所在单位：</span><span class="s3"><input type="text" id="cfjdbcfrzrrszdw" 
         name="cfjdbcfrzrrszdw" style="width: 240px;text-align: left;"value="${mybean.cfjdbcfrzrrszdw}"/></span>
         <span>住址：</span><span class="s3"><input type="text" id="cfjdbcfrzrrszdwdz" 
         name="cfjdbcfrzrrszdwdz" style="width: 300px;text-align: left;"value="${mybean.cfjdbcfrzrrszdwdz}"/></span>
        </p>
        <p class="p6">
        <span>被处罚人（单位）名称：</span><span class="s3"><input type="text" id="cfjdbcfrdwmc"
         name="cfjdbcfrdwmc" style="width: 600px;text-align: left;" value="${mybean.cfjdbcfrdwmc}"/></span>
        </p>
        <p class="p6">
         <span>地址：</span><span class="s3"><input type="text" id="cfjdbcfrdwdz"
          name="cfjdbcfrdwdz" style="width: 650px;text-align: left;" value="${mybean.cfjdbcfrdwdz}"/></span>
        </p>
        <p class="p6">
         <span>营业执照或其他资质证明：</span><span class="s3"><input type="text" id="cfjdbcfrdwyyzz" 
         name="cfjdbcfrdwyyzz" style="width: 150px;text-align: left;" value="${mybean.cfjdbcfrdwyyzz}"/></span>
         <span>编号：</span><span class="s3"><input type="text" id="cfjdbcfrdwyyzzbh" name="cfjdbcfrdwyyzzbh" 
         style="width: 150px;text-align: left;" value="${mybean.cfjdbcfrdwyyzzbh}"/></span>
        </p>
        <p class="p6">
         <span>法定代表人或负责人：</span><span class="s3"><input type="text" id="cfjdbcfrdwfddbr" 
         name="cfjdbcfrdwfddbr" style="width: 150px;text-align: left;" value="${mybean.cfjdbcfrdwfddbr}"/></span>
         <span>性别：</span><span class="s3"><input type="text" id="cfjdbcfrdwfddbrxb" name="cfjdbcfrdwfddbrxb" 
         style="width: 80px;text-align: left;" value="${mybean.cfjdbcfrdwfddbrxb}"/></span>
         <span>职务：</span><span class="s3"><input type="text" id="cfjdbcfrdwfddbrzw" name="cfjdbcfrdwfddbrzw"
          style="width: 120px;text-align: left;" value="${mybean.cfjdbcfrdwfddbrzw}"/></span>
        </p>
        <p class="p9">
        ...
        <p class="p10">
         ...
         style="width: 450px;text-align: left;" value="${mybean.cfjdwfxw}"/></span><span class="s2">违法行为。</span>
        </p>
        <p class="p11">
        ...
        <p class="p12">
         ...
         <p class="p15">
          ...
          style="width: 150px;text-align: left;" value="${mybean.cfjdjkyh}"/>银行（地址：                 ）。到期不缴纳的，每日按罚款数额的3%加处罚款。</span>
         </p>
         <p class="p15">
