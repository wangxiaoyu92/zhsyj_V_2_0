...
.p6{text-indent:-0.072916664in;margin-left:0.072916664in;text-align:start;hyphenate:auto;font-family:仿宋_GB2312;font-size:10.5pt;}
...
.p10{text-indent:0.29166666in;margin-left:0.072916664in;text-align:start;hyphenate:auto;font-family:仿宋_GB2312;font-size:10.5pt;}
.p11{text-indent:0.2777778in;margin-left:0.072916664in;text-align:start;hyphenate:auto;font-family:仿宋_GB2312;font-size:10.5pt;}
.p12{text-indent:0.06944445in;margin-top:0.108333334in;text-align:justify;hyphenate:auto;font-family:仿宋_GB2312;font-size:10.5pt;}
		...
		<form id="myform" method="post">
			...
			<p class="p5">
				...
				<span><input name="tztzsqrq" id="tztzsqrq" class="Wdate" style="width: 150px;"
					onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${mybean.tztzsqrq}"/></span>
				...
				<span><input name="tztzjxrq" id="tztzjxrq" class="Wdate" style="width: 150px;"
					onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})"  value="${mybean.tztzjxrq}"/></span>
			...
			<p class="p5">
				...
				<span><input name="tztzsyqrq" id="tztzsyqrq" class="Wdate" style="width: 150px;"
			...
			<p class="p10">
				...
				<span><input name="tztzstzsqrrq" id="tztzstzsqrrq" class="Wdate" style="width: 150px;"
					onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" value="${mybean.tztzstzsqrrq}"/></span>    
				<span>年   月   日</span>
			</p>
