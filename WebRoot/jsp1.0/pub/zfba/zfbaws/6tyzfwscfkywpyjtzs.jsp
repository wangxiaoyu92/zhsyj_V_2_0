...
<% 
    ...
    if (request.getAttribute("mybean") != null) {
    	dto = (Zfwscfkywpyjtzs6DTO) request.getAttribute("mybean");
    }	
%>
<html>
<head>
...
.p4{margin-right:0.038194444in;margin-top:0.108333334in;text-align:end;
	hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;margin-left:380px;}
...
.p6{text-indent:0.29166666in;margin-left:0.072916664in;text-align:start;
	hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;line-height: 2em;}
...
.p9{margin-right:0.038194444in;margin-top:0.108333334in;text-align:justify;
	hyphenate:auto;font-family:仿宋_GB2312;font-size:10pt;margin-left:540px;}
...
function myprint(){
	...
	var url = basePath + "pub/wsgldy/zfwscfkywpyjtzs6PrintIndex";
	//创建模态窗口
...
<body class="b1 b2 zfwsbackgroundcolor">
	<form id="myform" method="post">
		...
		<p class="p3">
		<input type="text" id="cfkytitle" name="cfkytitle"  
		...
		<p class="p4">
		<span class="s1">文书编号：
		<input type="text" id="wsbh" name="wsbh" style="width: 260px; " 
		value="${mybean.wsbh}" />
		</span>
		</p>
		...
		<span class="s3"><input type="text" id="sysbmmc" name="sysbmmc" 
					style="width: 260px; " value="${mybean.sysbmmc}"/>
		</span><span class="s1">公安局：</span>
		</p>
		<p class="p6" >
		因<input type="text" id="cfkywfxw" name="cfkywfxw" 
					style="width: 460px; " value="${mybean.cfkywfxw}"/>
		的违法行为涉嫌犯罪，根据《中华人民共和国行政强制法》第二十一条的规定，我局决定对查封(扣押)的
		<input type="text" id="cfkyygwp" name="cfkyygwp" 
					style="width: 560px; "  value="${mybean.cfkyygwp}"/>的有关物品［见 查封(扣押)决定书编号：
		<input type="text" id="cfkyjdswsbh" name="cfkyjdswsbh" 
					style="width: 360px; "  value="${mybean.cfkyjdswsbh}"/>《查封(扣押)决定书》所附《查封(扣押)物品清单》］移交给你单位。
		</p>
		<p class="p7"></p>
		<p class="p7"></p>
		<p class="p7"></p>
		...
		<input name="cfkyyjrq" id="cfkyyjrq" 
					...
					style="width: 175px;" value="${mybean.cfkyyjrq}" >
		</span>
		</p>
		<p class="p11"></p>
		<p class="p11"></p>
		...
		<p class="p11"></p>
		<p class="p12">
		<span class="s1">注：抄送（当事人），存档（1）。</span>
		</p>
		<p class="p13"></p>
		<hr style="height:2px;border:none;border-top:2px solid #555555;" />
		<table>
