	...
	$.ajax({
		...
		success:function(result){
			...
			$.each(data.outsize,function(index,entry){
				...
				outsizeStr += "<li>"+csclogo+"<a href='qyxq.jsp?id="+entry["id"]+"&systype="+entry["systype"]+"' target='_blank' onmouseout='hiddenDiv(\""+entry["id"]+"\")' onmouseover='showDiv(\""+entry["id"]+"\")'>"+enterprisename+"</a>"+
			...
			$.each(data.big,function(index,entry){
				...
				bigStr += "<li>"+csclogo+"<a href='qyxq.jsp?id="+entry["id"]+"&systype="+entry["systype"]+"' target='_blank' onmouseout='hiddenDiv(\""+entry["id"]+"\")' onmouseover='showDiv(\""+entry["id"]+"\")'>"+enterprisename+"</a>"+
				"<div id='"+entry["id"]+"' style='display:none;position:absolute;border:1px solid silver;background:white;border-radius:3px;margin-left:25px;' ><p style='margin:0;padding:5px;'>负责人："+entry["legaler"]+"</p><p style='margin:0;padding:5px;'>综合指数："+getCyLevel(entry["score"])+"</p></div> </li>";
			});
			$.each(data.middle,function(index,entry){
				...
				middleStr += "<li>"+csclogo+"<a href='qyxq.jsp?id="+entry["id"]+"&systype="+entry["systype"]+"' target='_blank' onmouseout='hiddenDiv(\""+entry["id"]+"\")' onmouseover='showDiv(\""+entry["id"]+"\")'>"+enterprisename+"</a>"+
				"<div id='"+entry["id"]+"' style='display:none;position:absolute;border:1px solid silver;background:white;border-radius:3px;margin-left:25px;' ><p style='margin:0;padding:5px;'>负责人："+entry["legaler"]+"</p><p style='margin:0;padding:5px;'>综合指数："+getCyLevel(entry["score"])+"</p></div> </li>";
			});
			$.each(data.small,function(index,entry){
				...
				smallStr += "<li>"+csclogo+"<a href='qyxq.jsp?id="+entry["id"]+"&systype="+entry["systype"]+"' target='_blank' onmouseout='hiddenDiv(\""+entry["id"]+"\")' onmouseover='showDiv(\""+entry["id"]+"\")'>"+enterprisename+"</a>"+
				"<div id='"+entry["id"]+"' style='display:none;position:absolute;border:1px solid silver;background:white;border-radius:3px;margin-left:25px;' ><p style='margin:0;padding:5px;'>负责人："+entry["legaler"]+"</p><p style='margin:0;padding:5px;'>综合指数："+getCyLevel(entry["score"])+"</p></div> </li>";
			});
			$.each(data.other,function(index,entry){
				...
				otherStr += "<li>"+csclogo+"<a href='qyxq.jsp?id="+entry["id"]+"&systype="+entry["systype"]+"' target='_blank' onmouseout='hiddenDiv(\""+entry["id"]+"\")' onmouseover='showDiv(\""+entry["id"]+"\")'>"+enterprisename+"</a>"+
				"<div id='"+entry["id"]+"' style='display:none;position:absolute;border:1px solid silver;background:white;border-radius:3px;margin-left:25px;' ><p style='margin:0;padding:5px;'>负责人："+entry["legaler"]+"</p><p style='margin:0;padding:5px;'>综合指数："+getCyLevel(entry["score"])+"</p></div> </li>";
			});
			// 写入div中
			$("#div_outsize").html("");
	...
	$.ajax({
		...
		success:function(result){
			...
			$.each(data.pfsc,function(index,entry){
				...
				pfscStr += "<li>"+csclogo+"<a href='qyxq.jsp?id="+entry["id"]+"&systype="+entry["systype"]+"' target='_blank' onmouseout='hiddenDiv(\""+entry["id"]+"\")' onmouseover='showDiv(\""+entry["id"]+"\")' >"+enterprisename+"</a>"+
			...
			$.each(data.lssc,function(index,entry){
				...
				lsscStr += "<li>"+csclogo+"<a href='qyxq.jsp?id="+entry["id"]+"&systype="+entry["systype"]+"' target='_blank' onmouseout='hiddenDiv(\""+entry["id"]+"\")' onmouseover='showDiv(\""+entry["id"]+"\")' >"+enterprisename+"</a>"+
				"<div id='"+entry["id"]+"' style='display:none;position:absolute;border:1px solid silver;background:white;border-radius:3px;margin-left:25px;' ><p style='margin:0;padding:5px;'>负责人："+entry["legaler"]+"</p><p style='margin:0;padding:5px;'>综合指数："+getStar(entry["score"])+"</p></div> </li>";
			});
			$.each(data.cs,function(index,entry){
				...
				csStr += "<li>"+csclogo+"<a href='qyxq.jsp?id="+entry["id"]+"&systype="+entry["systype"]+"' target='_blank' onmouseout='hiddenDiv(\""+entry["id"]+"\")' onmouseover='showDiv(\""+entry["id"]+"\")' >"+enterprisename+"</a>"+
				"<div id='"+entry["id"]+"' style='display:none;position:absolute;border:1px solid silver;background:white;border-radius:3px;margin-left:25px;' ><p style='margin:0;padding:5px;'>负责人："+entry["legaler"]+"</p><p style='margin:0;padding:5px;'>综合指数："+getStar(entry["score"])+"</p></div> </li>";
			});
			$.each(data.ds,function(index,entry){
				...
				dsStr += "<li>"+csclogo+"<a href='qyxq.jsp?id="+entry["id"]+"&systype="+entry["systype"]+"' target='_blank' onmouseout='hiddenDiv(\""+entry["id"]+"\")' onmouseover='showDiv(\""+entry["id"]+"\")' >"+enterprisename+"</a>"+
				"<div id='"+entry["id"]+"' style='display:none;position:absolute;border:1px solid silver;background:white;border-radius:3px;margin-left:25px;' ><p style='margin:0;padding:5px;'>负责人："+entry["legaler"]+"</p><p style='margin:0;padding:5px;'>综合指数："+getStar(entry["score"])+"</p></div> </li>";
			});
			$.each(data.llcc,function(index,entry){
				...
				llccStr += "<li>"+csclogo+"<a href='qyxq.jsp?id="+entry["id"]+"&systype="+entry["systype"]+"' target='_blank' onmouseout='hiddenDiv(\""+entry["id"]+"\")' onmouseover='showDiv(\""+entry["id"]+"\")' >"+enterprisename+"</a>" +
				"<div id='"+entry["id"]+"' style='display:none;position:absolute;border:1px solid silver;background:white;border-radius:3px;margin-left:25px;' ><p style='margin:0;padding:5px;'>负责人："+entry["legaler"]+"</p><p style='margin:0;padding:5px;'>综合指数："+getStar(entry["score"])+"</p></div> </li>";
			});
			// 写入div中
			$("#div_pfsc").html("");
	...
	$.ajax({
		...
		success:function(result){
			...
			$.each(data,function(index,entry){
				...
				str += "<li><a href='news.jsp?newsId="+entry["id"]+"' target='_blank' >"+newsname+"</a></li>";
				ulpic += "<li><a title='' target='_blank' href='news.jsp?newsId="+entry["id"]+"'><img width='425px' height='305px' alt='' text='' src='"+tppic+"'></a>"
				+"<div class='layout2_mask'></div><div class='layout2_comt'><h2>"+newsname+"</h2></div></li>";
				/*ulpic += "<li><a title='' target='_blank' href='#'><img width='480px' height='305px' alt='' style='background: url("+tppic+") no-repeat center;' ></a></li>"*/
			});
			// 写入div中
			/*$("#div_news").html("");
			$("#div_news").html(str);*/
