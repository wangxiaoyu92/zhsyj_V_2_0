...
<script type="text/javascript">
    ...
    function getPcompanyList(page,pageSize,t_aaa027) {
    	$.ajax({
        	...
        	type: "post",
            dataType: 'json',
            data: { page: page, rows: pageSize, comdalei: t_comdalei, comxiaolei: t_comxiaolei, aaa027: t_aaa027, commc: t_commc, comspjkbz: '1' },
                	...
                	$('#content').empty();
                 	$.each(result.rows, function (index, item) {
	                    ...
	                    var h_txt = "";
                     	...
                     	html += "         <a href=\"javascript:linkToSelf('enterprise_info.jsp?comid=" + item.comid + "&commc="+ item.commc + "&comxiaolei="+ item.comxiaolei + "&comdalei="+ item.comdalei + "');\"><img src=\"" + checkImg(item.icon) + "\" style=\"height:120px;width:160px;\" /></a>";
                     	html += "     </td>";
                     	html += "     <td><a href=\"javascript:linkToSelf('enterprise_info.jsp?comid=" + item.comid + "&commc="+ item.commc + "&comxiaolei="+ item.comxiaolei + "&comdalei="+ item.comdalei + "');\" style=\"font-size:17px;color:#0000F0;text-decoration:none;font-weight:bold;\" >" + item.commc + "</a></td>";
                     	html += " </tr>";
//                      	html += " <tr>";
