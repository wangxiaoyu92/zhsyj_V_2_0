...
// 	                    html += "<td>"+IsNull(item.spfenleiinfo)+"</td>";	                    
	                    ...
	                    html += "<td>"+IsNull(item.spbzq)+"</td>";
 	                    html += "<td><a href=\"javascript:void(0);\" onclick=\"spsycx('" + item.hjhbid + "','"+ item.eptbh + "','" + item.hviewjgztid + "','" + item.jgztmc + "','" + item.jcypmc + "');\" style=\"background: #4fb9f1;color: #fff;padding: 5px 5px;border-radius: 6px;font-size:11pt;text-decoration:none;\">全程追溯</a>";
