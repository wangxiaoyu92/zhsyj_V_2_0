                	...
                	$('#content').empty();
                 	$.each(result.rows, function (index, item) {
	                    ...
	                    var h_txt = "";
                     	...
                     	html += "         <a href=\"javascript:linkToSelf('ylcgtm_info.jsp?hviewjgztid=" + IsNull(item.hviewjgztid) + "&fjwid="+ IsNull(item.hjgztxgpicid) +  "');\"><img src=\"" + checkImg(item.fjpath) + "\" style=\"height:120px;width:160px;\" /></a>";
                     	html += "     </td>";
                     	html += "     <td><a href=\"javascript:linkToSelf('ylcgtm_info.jsp?hviewjgztid=" + IsNull(item.hviewjgztid) + "&fjwid="+ IsNull(item.hjgztxgpicid) +  "');\" style=\"font-size:17px;color:#0000F0;text-decoration:none;font-weight:bold;\" >自查时间：" + IsNull(item.zcsj) + "</a></td>";
                     	html += " </tr>";
                     	html += " <tr>";
