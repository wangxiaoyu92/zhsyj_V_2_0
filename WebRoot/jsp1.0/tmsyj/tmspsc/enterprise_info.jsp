		   	...
		   	<div id="transparent" style="padding-bottom:10px;">
				<div class="enterprise-transparent">
					...
					<%--<a href="javascript:linkToSelf('ylcgtm_list.jsp?currlocation=<%=t_commc %>>>原料采购透明&comid=<%=t_comid %>');"--%>
						<%--style="background: #ff6950;" id="cgtm">原料采购透明</a>--%>
					<a href="javascript:linkToSelf('ylcgtm_list.jsp?currlocation=<%=t_commc %>>>企业自查透明&comid=<%=t_comid %>');"
					   style="background: #ff6950;" id="cgtm">企业自查透明</a><a href="javascript:linkToSelf('cpxxtm_list.jsp?currlocation=<%=t_commc %>>>产品信息透明&comid=<%=t_comid %>');"
				...
				<div class="enterprise-transparent">
					...
					<a href="javascript:linkToSelf('jyjctm_list.jsp?currlocation=<%=t_commc %>>>监督抽检透明&comid=<%=t_comid %>');"
					   style="background: #d21323;" id="sptm">监督抽检透明</a>
