				...
				<sicp3:groupbox title="查询条件">
					<table class="table" style="width: 99%;">
						<tr>
							...
							<td><input id="filetitle" name="filetitle"
								style="width: 200px" /></td>
							<td style="text-align:right;"><nobr>操作员</nobr>
							</td>
							<td><input id="fileopperuser" name="fileopperuser"
								style="width:200px" />
							</td>
						</tr>
						<tr>
					...
					<div id="toolbar">
						<table>
							<tr>
								...
								<td><a href="javascript:void(0)" class="easyui-linkbutton"
									id="btn_delgdArchive" name="btn_delgdArchive" data="btn_delgdArchive"
									iconCls="icon-remove" plain="true" onclick="delgdArchive()">删除</a></td>
							</tr>
						</table>
					</div>
