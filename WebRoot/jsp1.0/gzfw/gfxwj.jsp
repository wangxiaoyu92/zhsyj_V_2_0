...
<div class="mid_bg">
  <div class="top_4">
    <div class="top_4d fl" id="DangQianWeiZhi"><span>当前位置</span>&nbsp;&gt;&nbsp;法律法规&nbsp;&gt;&nbsp;规范性文件</div>    
    <div class="top_4c fr">
...
<script type="text/javascript">
  function myshowpostion(){
	  ...
	  if (v_local_catejc==null || v_local_catejc=="" || v_local_catejc=="flfg_gfxwj"){
...
<div class="mid_bg">
  ...
  <div class="ntit_2">
     <ul>
      ...
      <li class="marr10"><a id="flfg_xzfg" href="<%=contextPath %>/news/queryNewsList?retPageStr=xzfg&pageSize=20&cateJc=flfg_xzfg&page=1" >行政法规</a></li>
      <li class="marr10"><a id="flfg_gz"  href="<%=contextPath %>/news/queryNewsList?retPageStr=gz&pageSize=20&cateJc=flfg_gz&page=1" >规章</a></li>
      <li><a id="flfg_gfxwj" href="<%=contextPath %>/news/queryNewsList?retPageStr=gfxwj&pageSize=20&cateJc=flfg_gfxwj&page=1" class="curr">规范性文件</a></li>
    </ul>
  </div>
