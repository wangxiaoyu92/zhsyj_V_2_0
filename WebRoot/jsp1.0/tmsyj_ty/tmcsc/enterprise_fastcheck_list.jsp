            	...
            	if(result.code == '0'){
            		options.currentPage = result.currPage;
                 	...
                 	if(result.total>5){                	
                 		...
                 		var html2 = "";                       
                        html2 += " <tr>";
                        html2 += "   <td style=\"text-align:center\"><a onclick='showPic(\"images/kj01.jpg\")' ><img style=\"width:316px; height:222px;\" src=\"images/kj01.jpg\"/></a></td>";
                        html2 += "   <td style=\"text-align:center\"><a onclick='showPic(\"images/kj03.jpg\")' ><img style=\"width:316px; height:222px;\" src=\"images/kj03.jpg\"/></a></td>";
                        html2 += "   <td style=\"text-align:center\"><a onclick='showPic(\"images/kj04.jpg\")' ><img style=\"width:316px; height:222px;\" src=\"images/kj04.jpg\"/></a></td>";
//                         html2 += "   <td style=\"text-align:center\"><img style=\"width:316px; height:222px;\" rel=\"images/kj01.jpg\" src=\"images/kj01.jpg\" class=\"jqzoom\" /></td>";
//                         html2 += "   <td style=\"text-align:center\"><img style=\"width:316px; height:222px;\" rel=\"images/kj02.jpg\" src=\"images/kj02.jpg\" class=\"jqzoom\" /></td>";                        
                        html2 += " </tr>";                                                                      	
                    	$('#content tbody').append(html2);	
                 	}                        
              	}else{
                	alert(result.msg);	                       
              	} 
