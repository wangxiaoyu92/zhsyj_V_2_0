...
<script type="text/javascript">
	...
	function uploadFjViewCanNoIdBase(prm_fjtype) {
	    ...
	    var dialog = parent.sy.modalDialog({
			...
			url : basePath + "/pub/pub/uploadFjViewIndex?folderName=jchhgzm&fjwid="+v_fjwid+"&fjtype="+v_fjtype            
		},function(dialogID){
	...
	var myselectShangpinBase = function() {
	    ...
	    var dialog = parent.sy.modalDialog({
			...
			width : 860,
			height : 460,
			url : basePath + 'pub/pub/selectShangpinIndex?spsjlx=1&querykind=1&singleSelect='+v_singleSelect+'&a='+new Date().getMilliseconds(),
			buttons : [ {
				text : '确定',
				handler : function() {
