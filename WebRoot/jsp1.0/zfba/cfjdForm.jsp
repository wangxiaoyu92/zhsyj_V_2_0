...
<script type="text/javascript">
	...
	var submitForm = function($dialog, $grid, $pjq) {
		...
		$('#ajdjAddDlgfm').form('submit',{
			url:  basePath + '/zfba/cfjd/saveUpdateCfjd',
			onSubmit: function(){ 
		...
		<form id="ajdjAddDlgfm" method="post">
			<sicp3:groupbox title="案件 处罚决定">
				<table class="table" style="width: 99%;">
					...
					<tr>
						<td style="text-align:right;"><nobr>处罚程序:</nobr></td>
						<td colspan="3">
							<input type="radio" name="cfjdcx" id="cfjdcx" value="1" checked="checked"/>一般程序
							<input type="radio" name="cfjdcx" id="cfjdcx" value="2"/>听证程序
							<input type="radio" name="cfjdcx" id="cfjdcx" value="3"/>简易程序
						</td>
					</tr>
				</table>
			</sicp3:groupbox>
