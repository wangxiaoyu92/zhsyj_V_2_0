...
<body>  
 <form id="myfm" name="fr" method="post"> 
  ...
  <!-- 默认添加为材料 -->
  <input type="hidden" value="1" id="cphyclbz" name="cphyclbz" /> 
  <sicp3:groupbox title="产品或原材料信息">
   <table class="table" style="width: 99%;" >
	<tr>
         <td class="title" width="15%">产品名称</td>
         <td align="left" colspan="3" >
         <input type="text" id="proname" name="proname"  data-options="required:true" class="easyui-validatebox"  style="width: 580px;"/>
         </td>
    </tr>
    <tr>
    ...
    <tr>
         ...
         <select id="cate" class="easyui-combobox "  name="probzqdwcode" style="width:50px;"  ></select>
    ...
    <tr>
         ...
         <td align="left" colspan="3">
         <select id="prozl" name="prozl" style="width:120px;" class="easyui-combobox " data-options="required:true"></select>
         </td>    
    </tr>
    <tr>
