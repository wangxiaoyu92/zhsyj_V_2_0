...
var v_scdwdm = <%=SysmanageUtil.getAa10toJsonArray("CPPCSCDWDM")%>;
		...
		mygrid = $('#mygrid').datagrid({
			...
			columns : [ [
	        {
	            ...
	            formatter:function(value,rec){ 
					  var v_ret ='<a href="javascript:uploadFjView(\''+rec.cppcid+'\')" mce_href="#">'
					  	+'<img src="<%=basePath%>images/pub/up2.png" align="absmiddle">图片上传  </a>'
	...
	// 上传图片附件
	function uploadFjView(prm_fjwid){
		var url = basePath + 'pub/pub/uploadFjViewIndex';
		var dialog = parent.sy.modalDialog({
				title : '上传附件',
				param : {
					folderName : "comjyjcpic",
					fjwid : prm_fjwid
				},
				width : 900,
				height : 700,
