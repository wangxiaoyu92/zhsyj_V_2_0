...
var v_scdwdm = <%=SysmanageUtil.getAa10toJsonArray("CPPCSCDWDM")%>;
		...
		mygrid = $('#mygrid').datagrid({
			...
			columns : [ [
	        {
	            ...
	            formatter:function(value,rec){ 
					  var v_ret = '<a href="javascript:addScszxx(\''+rec.cppcpch+'\')" mce_href="#">'
					  	+'<img src="<%=basePath%>images/pub/edit_add.png" align="absmiddle">添加生产生长信息</a>&nbsp;'
					  	+'<a href="javascript:showScszxx(\''+rec.cppcpch+'\')" mce_href="#">'
					  	+'<img src="<%=basePath%>images/pub/doc2.png" align="absmiddle">查看生产生长信息</a>'	;
	                  return  v_ret; 
	             }   
	        }
			] ]
	...
	// 查看生产生长信息
	function showScszxx(cppcpch) {
		var v_productid = $("#productid").val();
		var url = basePath + 'spsy/spproduct/showScszxxFromIndex';
		var dialog = parent.sy.modalDialog({
				title : '查看生产生长信息',
				param : {
					proid : v_productid,
