...
<script type="text/javascript">
	...
	//编辑诚信评定等级参数信息
	var Jyjcjgsh = function(){
		var url=basePath + '/jyjc/jyjcjgshFormIndex';
		...
		if(row){
			...
			$.messager.alert('提示','请先选择要审核的检验检测结果信息！','info');
		}
	}
        	...
        	<sicp3:groupbox title="查询条件">
        		<table class="table" style="width: 99%;">
					...
					<tr><td style="text-align:right;"><nobr>检验员</nobr></td>
						<td><input id="jyy" name="jyy" style="width: 200px"/></td>					
						<td colspan="2">
							<a href="javascript:void(0)" class="easyui-linkbutton"
	        		...
	        		<table>
						<tr>
							<td><a href="javascript:void(0)" class="easyui-linkbutton" data="btn_saveJyjcjg"
								iconCls="icon-edit" plain="true" onclick="Jyjcjgsh()">审核处理</a> 
							</td> 
							<td><a href="javascript:void(0)" class="easyui-linkbutton" data="btn_jyjcjgshFormIndex"
