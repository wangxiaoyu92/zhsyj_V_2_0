        ...
        <div region="center" style="overflow: true;" border="false">
        	<sicp3:groupbox title="查询条件">
        		<table class="table" style="width: 99%;">
					...
					<tr><td style="text-align:right;"><nobr>检测检验类别</nobr></td>
						<td><input id="jcjylb" name="jcjylb" style="width: 200px"/></td>					
						<td style="text-align:right;"><nobr>检测日期</nobr></td>
						<td>
						<input id="ksSj" name="ksSj"   onClick="WdatePicker({maxDate:'#F{$dp.$D(\'jzSj\')}'})" class="Wdate bbinput" readonly="readonly"/>
						--
						<input id="jzSj" name="jzSj"   onClick="WdatePicker({minDate:'#F{$dp.$D(\'ksSj\')}'})" class="Wdate bbinput" readonly="readonly"/>
						</td>	
					</tr>
					<tr>
					<td colspan="4">
