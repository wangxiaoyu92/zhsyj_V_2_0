		...
		$('#fm').form('submit',{
			...
			onSubmit: function(){ 
				...
				if(!isValid){
					...
					var newsispicture =0; //$("#newsispicture").combobox('getValue');
					if(newsispicture == '1'){
						/*
        		...
        		<sicp3:groupbox title="编辑法律法规">
	        		<table class="table" style="width: 99%;">	        		    
						...
						<tr hidden="hidden">						
							...
							<td><input id="cateid" name="cateid" style="width: 200px;" disabled="disabled" value="6"/></td>			
						</tr>
						<tr>
							<td style="text-align:right;"><nobr>法律标题：</nobr></td>
							<td><input id="newstitle" name="newstitle" style="width: 400px;" class="easyui-validatebox" data-options="required:true" value="<%=newstitle %>"/></td>						
						</tr>
						<tr>		
						...
						<tr hidden="hidden">		
							...
							<td><input id="sfyx" name="sfyx" style="width: 200px;"  disabled="disabled"  value="有效" /></td>
						</tr>
						
						<tr hidden="hidden">		
							<td style="text-align:right;"><nobr>是否图片：</nobr></td>
							<td><input id="newsispicture" name="newsispicture" style="width: 200px;" disabled="disabled"  value="否" /></td>
						</tr>
						<tr>		
