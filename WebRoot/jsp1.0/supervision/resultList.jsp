...
<script type="text/javascript">
	...
	function query() {
		...
		var resultstate=$("#resultstate").combobox('getValue');
...
// 			},
	...
	if(row.resultstate="4"){//结果固化
		var dialog = parent.sy.modalDialog({
				...
				width :1040,
				height :560,
				url : basePath +'supervision/checkresult/viewResultinfo',
				param : {
					resultid : row.resultid,
					resultstate : row.resultstate,
					planchecktype : row.planchecktype
	        ...
	        <form id="fm" name="fm" method="post">		
				<table class="table" style="width: 80%;">
					<tr>
						...
						<td style="text-align:right;" ><nobr>检查状态</nobr></td>	
						<td>
							<input id="resultstate" name="resultstate" class="easyui-combobox" 
							data-options="
							        panelHeight:'200px',
									valueField: 'label',
									textField: 'value',
					...
					<tr>
						...
						<td colspan="2"><input type="text" id="operatedate" name="operatedate"    onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'operateenddate\')}',readOnly:true})" class="Wdate" readonly="readonly"/> 					
