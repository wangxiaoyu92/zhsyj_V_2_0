...
<body>
	<form id="fm" method="post">
		<input name="filepath" id="filepath"  type="hidden" />
        	<sicp3:groupbox title="项目内容信息">	
        		<table class="table" style="width: 99%;">
					<tr  hidden="true">
						<td style="text-align:right;"><nobr>项目ID</nobr></td>
						<td colspan="3">
							<input id="itemid" name="itemid" style="width: 200px;" readonly="readonly"  value='<%=itemid%>'/>
						</td>	
					</tr>
					<tr>
						<td style="text-align:right;"><nobr>编号</nobr></td>
						<td><input id="contentcode"  name="contentcode" style="width: 200px;" class="easyui-validatebox" data-options="required:true"/></td>	
						<td style="text-align:right;"><nobr>重要性</nobr></td>
						<td><input id="contentimpt"  name="contentimpt" style="width: 200px;"/></td>				
					</tr>
					<tr>
						<td style="text-align:right;"><nobr>评级分值</nobr></td>
						<td><input id="contentscore" name="contentscore" style="width: 200px;"/></td>		
						<td style="text-align:right;"><nobr>排序号</nobr></td>
						<td><input id="contentsortid" name="contentsortid" style="width: 200px;" class="easyui-validatebox" data-options="required:true"/></td>			
<!-- 					</tr>				 -->
					<tr>						
						<td style="text-align:right;">项目内容:</td>
						<td colspan="3">
							<textarea class="easyui-validatebox" id="content" name="content" style="width: 600px;" 
						 	rows="5" data-options="required:true,validType:'length[0,500]'"></textarea>
						</td>			
					</tr>	
				</table>
				<td><input id="contentid" name="contentid" style="width: 200px;" hidden="true" value='<%=contentid%>'/></td>
	        </sicp3:groupbox>
	   </form>
</body>
</html>