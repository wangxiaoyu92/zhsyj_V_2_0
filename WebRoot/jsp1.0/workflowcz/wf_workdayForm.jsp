...
$(function() {
	...
	*/
	...
	$("#olookup").click(function() {
		...
		$.messager.confirm('警告', tipMsg ,function(r) {
			if (r) {
...
<div region="center" style="overflow: false; width: 1000px;height: 600px;" border="false">
	<a href="" id="goLocation" style="display:none">不会打开新窗口哦</a>    
	<sicp3:groupbox title="工作日信息">	
		<div id="Mns">
...
<!-- 					<a href="#" id="oyeardown" name="lookup" class="easyui-linkbutton">下一年&gt;&gt;</a> -->
					...
					<a href="#" id="olookup" name="lookup" class="easyui-linkbutton">保存工作日设置</a>
						&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="#" class="easyui-linkbutton" onclick="closeAndRefreshWindow()">关闭返回</a>
