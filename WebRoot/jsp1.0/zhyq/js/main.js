(function ($) {
    ...
    /*	WEIXIN
     /*===================================================================================*/
    var wxtitle = "安盛科技";
    var wxdesc = "国内领先的食药安全监管解决方案服务商";
    var wxlink = "http://www.hnaskj.com/"
    var wximgUrl = "http://www.hnaskj.com/img/weixin.png";
    $.ajax({
        async: false,
        url: 'http://www.hnaskj.com/weixin/jsapi.php?&urlStr=' + encodeURIComponent(window.location.href),
        type: "GET",
        dataType: 'json',
        timeout: 5000,
        beforeSend: function () {
