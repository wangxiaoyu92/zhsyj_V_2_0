...
<script type="text/javascript">
	...
	// 注册
	function quzhuce(){
		//window.open("<%=basePath%>jsp/zrb/zrbUserReg.jsp");
		window.location.href="<%=basePath%>jsp/signups/signup/signupUserReg.jsp";
	};
	// 找回密码
	function findpw(){
		//window.open("<%=basePath%>jsp/zrb/zrbFindUserPw.jsp");
		window.location.href="<%=basePath%>jsp/signups/signup/signupFindUserPw.jsp";
	};
</script>
</head>
<body class="LoginBgStyle">
	...
	<!-- 										        				<a href="javascript:void(0)" onclick="getYzm();" id="yzmBtn"><img src="<%=contextPath%>/images/login/hqyzm.png"/></a> -->
											...
											<table width="351" border="0" cellspacing="0" cellpadding="0">
												...
												<tr><td>&nbsp;</td></tr>
												<tr>
													<td><a id="azc" style="font-size: 14px;" href="javascript:void(0)" onclick="quzhuce();">
														<img id="zc" title="新用户注册" class="easyui-tooltip"
															 src="<%=contextPath%>/images/login/zc2.png"  alt="注册" /></a>
													</td>
													<td style="text-align: right;">
														<a style="font-size: 14px;" onclick="findpw();">忘记密码？点这里找回！</a>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
												</tr> 
											</table>	
										</form>									
