...
/**
 * @Description  ZFWSTZYJS25的中文含义是: 听证意见书; InnoDB free: 2726912 kB
 * @Creation     2016/06/08 15:47:46
 * @Written      Create Tool By zjf 
 **/
@Table(value = "ZFWSTZYJS25")
public class Zfwstzyjs25 {
	/**
	 * @Description tzyjsid的中文含义是： 听证意见书ID
	 */
	@Column
	@Name
	//@Prev(@SQL(db=DB.MYSQL,value="select nextval('sq_tzyjsid')"))
	//@Prev(@SQL(db=DB.ORACLE,value="select sq_tzyjsid.nextval from dual"))
