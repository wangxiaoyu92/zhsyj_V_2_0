...
/**
 * @Description  ZDHDDJ的中文含义是: 重大活动登记表; InnoDB free: 11264 kBDTO
 * @Creation     2016/11/09 11:34:54
 * @Written      Create Tool By zjf 
 **/
public class ZdhddjDTO {
	/**
	 * @Description zdhdjcryidlist的中文含义是： 检查人员id串
	 */
	private String zdhdjcryidlist;	
	/**
	 * @Description zdhdjcryidstr的中文含义是： 检查人员中文字符串，中文字符串
	 */
	private String zdhdjcryidliststr;	
	/**
	 * @Description commc的中文含义是： 公司名称
	 */
	private String commc;		
	/**
	 * @Description aae036start的中文含义是： 登记开始时间
	 */
	private String aae036start;		
	/**
	 * @Description aae036end的中文含义是： 登记结束时间
	 */
	private String aae036end;	
	/**
	 * @Description aaa027name的中文含义是： 地区编码名称
	 */
	...
	public String getZdhdjcryidlist() {
		return zdhdjcryidlist;
	}
	public void setZdhdjcryidlist(String zdhdjcryidlist) {
		this.zdhdjcryidlist = zdhdjcryidlist;
	}
	public String getZdhdjcryidliststr() {
		return zdhdjcryidliststr;
	}
	public void setZdhdjcryidliststr(String zdhdjcryidliststr) {
		this.zdhdjcryidliststr = zdhdjcryidliststr;
	}
