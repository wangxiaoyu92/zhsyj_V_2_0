...
public class HjyjczbDTO {
	...
	/** jyjcjl 的中文含义是：检验检测结论aaa100=JCHSCJYJL*/
	...
	public String getJcmxbgriddata() {
		return jcmxbgriddata;
	}

	public void setJcmxbgriddata(String jcmxbgriddata) {
		this.jcmxbgriddata = jcmxbgriddata;
	}
