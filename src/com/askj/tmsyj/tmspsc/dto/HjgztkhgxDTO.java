package com.askj.tmsyj.tmspsc.dto;

public class HjgztkhgxDTO {
/** 监管主体客户关系表  */
	...
	private String jgztkhzzzmmcinfo;
	...
	public String getJgztkhzzzmmcinfo() {
		return jgztkhzzzmmcinfo;
	}

	public void setJgztkhzzzmmcinfo(String jgztkhzzzmmcinfo) {
		this.jgztkhzzzmmcinfo = jgztkhzzzmmcinfo;
	}

	public String getJgztkhgxinfo() {
		return jgztkhgxinfo;
	}

	public void setJgztkhgxinfo(String jgztkhgxinfo) {
		this.jgztkhgxinfo = jgztkhgxinfo;
	}
