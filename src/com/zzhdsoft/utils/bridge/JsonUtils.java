...
public class JsonUtils {
     ...
     * @return <ul>
     * <li>if jsonObject is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#(String)} exception, return defaultValue</li>
     ...
     * <li>if jsonObject is null, return defaultValue</li>
     * <li>if key is null or empty, return defaultValue</li>
     * <li>if {@link JSONObject#(String)} exception, return defaultValue</li>
     * <li>return {@link JSONObject#(String)}</li>
     * </ul>
     */
     ...
     * <li>if jsonData {@link JSONObject#(String)} exception, return null</li>
     * </ul>
     */
    ...
    public static Map<String, String> parseKeyAndValueToMap(JSONObject sourceObj) {
        ...
        for (Iterator iter = sourceObj.keySet().iterator(); iter.hasNext(); ) {
