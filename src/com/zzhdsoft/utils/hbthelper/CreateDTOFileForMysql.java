 ...
 *  Written  by  : zjf
 */
public class CreateDTOFileForMysql {
	static String javafilepack = "com.zzhdsoft.siweb.dto.zfba";//更改包路径
	static String javafilepackPath = "./src/com/zzhdsoft/siweb/dto/zfba/";//类文件路径
	static String db_name = "syjzhptty0316";//mysql数据库名
    public CreateDTOFileForMysql() {
    }
    /**
     * @param args
     */
    public static void main(String args[]){
        String tablename = "pcomxiaolei"; //更改此名称可以生成不同的表HBFile
        if (args!=null && args.length==1)
        {
            if (CreateHBFile(args[0]))
                System.out.println("成功创建或更新DTO文件.");
        }
        else
        {
    ...
    public static boolean CreateHBFile(String tablename){
        ...
        //java类首字母大写
        String javaclassname = StringHelper.firstCharacterToUpper(StringHelper.replaceUnderlineAndfirstToUpper(tablename.toLowerCase(),"_"))+"DTO";
