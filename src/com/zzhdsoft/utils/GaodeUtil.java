...
public class GaodeUtil {
	 ...
	 * 
	 */
	public static Map getMapLngAndLat(String address) throws UnsupportedEncodingException {
		Map<String, String> map = new HashMap<String, String>();
		
		String url = "http://restapi.amap.com/v3/geocode/geo?key=0925632a7fccfbd7cac234649f660e4d&address=" + URLEncoder.encode(address, "UTF-8")+"&output=JSON";
		String retString = loadJSON(url);
		
		JSONObject obj = JSONObject.fromObject(retString);
	...
	public static Map<String, String> getMapAddress(String Lng, String Lat) {
		...
		String url = "http://restapi.amap.com/v3/geocode/regeo?key=0925632a7fccfbd7cac234649f660e4d&location=" + location;
	 ...
	 * 
	 */
	public static String getDistance(String lng1Str, String lat1Str, String lng2Str, String lat2Str) {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		Map map = GaodeUtil.getMapLngAndLat("汝州市煤山街道办事处洪山庙村");
		System.out.println("经度：" + map.get("lng") + "---纬度：" + map.get("lat"));

		Map<String, String> map2 = GaodeUtil.getMapAddress("114.377046", "35.92348");
		System.out.println("地址：" + map2.get("address"));

		String distance = getDistance("117.11811", "36.68484", "117.00999000000002", "36.66123");
		System.out.println(distance);

		// 济南国际会展中心经纬度：117.11811 36.68484
		// 趵突泉：117.00999000000002 36.66123
		System.out.println(getDistance("117.11811", "36.68484", "114.076401", "32.967014"));
